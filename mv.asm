...
main(int argc, char *argv[])
{
  ...
  1c:	50                   	push   %eax
  1d:	50                   	push   %eax
  1e:	68 cc 08 00 00       	push   $0x8cc
  23:	6a 01                	push   $0x1
  25:	e8 26 05 00 00       	call   550 <printf>
    exit();
  2a:	e8 c3 03 00 00       	call   3f2 <exit>
  }
  ...
  36:	e8 f7 03 00 00       	call   432 <open>
  3b:	83 c4 10             	add    $0x10,%esp
  3e:	85 c0                	test   %eax,%eax
  40:	89 c6                	mov    %eax,%esi
  42:	78 43                	js     87 <main+0x87>
  ...
  4e:	e8 df 03 00 00       	call   432 <open>
  53:	83 c4 10             	add    $0x10,%esp
  56:	85 c0                	test   %eax,%eax
  58:	89 c7                	mov    %eax,%edi
  5a:	78 40                	js     9c <main+0x9c>
    }
    cp1(fdread,fdwrite);
    chdir("..");
    remove(argv[1]);
  ...
  5e:	57                   	push   %edi
  5f:	56                   	push   %esi
  60:	e8 fb 00 00 00       	call   160 <cp1>
    remove(argv[1]);
  65:	5a                   	pop    %edx
  66:	ff 73 04             	pushl  0x4(%ebx)
  69:	e8 c2 00 00 00       	call   130 <remove>
  ...
  74:	56                   	push   %esi
  75:	e8 a0 03 00 00       	call   41a <close>
  close(fdwrite);  
  7a:	89 3c 24             	mov    %edi,(%esp)
  7d:	e8 98 03 00 00       	call   41a <close>
  exit();
  82:	e8 6b 03 00 00       	call   3f2 <exit>
    printf(1, "usege: mv [filename] [filename or dir]\n");
    exit();
  }
  ...
  8b:	68 89 08 00 00       	push   $0x889
  90:	6a 01                	push   $0x1
  92:	e8 b9 04 00 00       	call   550 <printf>
    exit();
  97:	e8 56 03 00 00       	call   3f2 <exit>
  }
  if((fdwrite = open(argv[2], O_CREATE|O_RDWR)) < 0){
    if(chdir(argv[2])<0){
  9c:	83 ec 0c             	sub    $0xc,%esp
  9f:	ff 73 08             	pushl  0x8(%ebx)
  a2:	e8 bb 03 00 00       	call   462 <chdir>
  a7:	83 c4 10             	add    $0x10,%esp
  aa:	85 c0                	test   %eax,%eax
  ac:	78 47                	js     f5 <main+0xf5>
  ...
  d1:	50                   	push   %eax
  d2:	56                   	push   %esi
  d3:	e8 88 00 00 00       	call   160 <cp1>
    chdir("..");
  d8:	c7 04 24 c6 08 00 00 	movl   $0x8c6,(%esp)
  df:	e8 7e 03 00 00       	call   462 <chdir>
    remove(argv[1]);
  e4:	58                   	pop    %eax
  e5:	ff 73 04             	pushl  0x4(%ebx)
  e8:	e8 43 00 00 00       	call   130 <remove>
  ed:	83 c4 10             	add    $0x10,%esp
  f0:	e9 7c ff ff ff       	jmp    71 <main+0x71>
    printf(1, "mv: cannot open %s\n", argv[1]);
    exit();
  }
  if((fdwrite = open(argv[2], O_CREATE|O_RDWR)) < 0){
  ...
  f9:	68 9d 08 00 00       	push   $0x89d
  fe:	6a 01                	push   $0x1
 100:	e8 4b 04 00 00       	call   550 <printf>
      exit();
 105:	e8 e8 02 00 00       	call   3f2 <exit>
    }
    close(fdwrite);
    if((fdwrite = open(argv[1], O_CREATE|O_RDWR)) < 0){
      printf(1, "mv: cannot open %s/%s\n", argv[2],argv[1]);
 10a:	ff 73 04             	pushl  0x4(%ebx)
 10d:	ff 73 08             	pushl  0x8(%ebx)
 110:	68 af 08 00 00       	push   $0x8af
 115:	6a 01                	push   $0x1
 117:	e8 34 04 00 00       	call   550 <printf>
      exit();
 11c:	e8 d1 02 00 00       	call   3f2 <exit>
...
void remove(char* file){
 ...
 137:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if(unlink(file)<0){
 13a:	53                   	push   %ebx
 13b:	e8 02 03 00 00       	call   442 <unlink>
 140:	83 c4 10             	add    $0x10,%esp
 143:	85 c0                	test   %eax,%eax
 145:	78 05                	js     14c <remove+0x1c>
...
void remove(char* file){
 ...
 14c:	50                   	push   %eax
 14d:	53                   	push   %ebx
 14e:	68 70 08 00 00       	push   $0x870
 153:	6a 02                	push   $0x2
 155:	e8 f6 03 00 00       	call   550 <printf>
    exit();
 15a:	e8 93 02 00 00       	call   3f2 <exit>
 15f:	90                   	nop
...
void cp1(int fdread,int fdwrite){
 ...
 16b:	eb 15                	jmp    182 <cp1+0x22>
 16d:	8d 76 00             	lea    0x0(%esi),%esi
    write(fdwrite, buf, n);//文字出力
 170:	83 ec 04             	sub    $0x4,%esp
 173:	50                   	push   %eax
 174:	68 20 0c 00 00       	push   $0xc20
 179:	56                   	push   %esi
...
void cp1(int fdread,int fdwrite){
 ...
 18a:	68 20 0c 00 00       	push   $0xc20
 18f:	53                   	push   %ebx
 190:	e8 75 02 00 00       	call   40a <read>
 195:	83 c4 10             	add    $0x10,%esp
 198:	85 c0                	test   %eax,%eax
 19a:	7f d4                	jg     170 <cp1+0x10>
    write(fdwrite, buf, n);//文字出力
  }
}
 19c:	8d 65 f8             	lea    -0x8(%ebp),%esp
 19f:	5b                   	pop    %ebx
 1a0:	5e                   	pop    %esi
 1a1:	5d                   	pop    %ebp
 1a2:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4ef:	f7 f6                	div    %esi
 4f1:	0f b6 92 fc 08 00 00 	movzbl 0x8fc(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 668:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 66b:	b8 f4 08 00 00       	mov    $0x8f4,%eax
...
free(void *ap)
{
 ...
 6f1:	a1 00 0c 00 00       	mov    0xc00,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 747:	89 08                	mov    %ecx,(%eax)
  freep = p;
 749:	a3 00 0c 00 00       	mov    %eax,0xc00
}
 74e:	5b                   	pop    %ebx
 74f:	5e                   	pop    %esi
 750:	5f                   	pop    %edi
 ...
 76a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 76d:	a3 00 0c 00 00       	mov    %eax,0xc00
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 789:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 78c:	8b 15 00 0c 00 00    	mov    0xc00,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 82c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 82f:	89 15 00 0c 00 00    	mov    %edx,0xc00
      return (void*)(p + 1);
 ...
 844:	eb e9                	jmp    82f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 846:	c7 05 00 0c 00 00 04 	movl   $0xc04,0xc00
 84d:	0c 00 00 
 850:	c7 05 04 0c 00 00 04 	movl   $0xc04,0xc04
 857:	0c 00 00 
    base.s.size = 0;
 85a:	b8 04 0c 00 00       	mov    $0xc04,%eax
 85f:	c7 05 08 0c 00 00 00 	movl   $0x0,0xc08
 866:	00 00 00 
