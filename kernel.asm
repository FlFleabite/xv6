...
80100046:	68 e0 6f 10 80       	push   $0x80106fe0
8010004b:	68 60 b6 10 80       	push   $0x8010b660
80100050:	e8 bb 40 00 00       	call   80104110 <initlock>

//PAGEBREAK!
  // Create linked list of buffers
  bcache.head.prev = &bcache.head;
80100055:	c7 05 70 f5 10 80 64 	movl   $0x8010f564,0x8010f570
8010005c:	f5 10 80 
  bcache.head.next = &bcache.head;
8010005f:	c7 05 74 f5 10 80 64 	movl   $0x8010f564,0x8010f574
80100066:	f5 10 80 
80100069:	83 c4 10             	add    $0x10,%esp
8010006c:	b9 64 f5 10 80       	mov    $0x8010f564,%ecx
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
80100071:	b8 94 b6 10 80       	mov    $0x8010b694,%eax
...
80100082:	89 48 10             	mov    %ecx,0x10(%eax)
    b->prev = &bcache.head;
80100085:	c7 40 0c 64 f5 10 80 	movl   $0x8010f564,0xc(%eax)
8010008c:	89 c1                	mov    %eax,%ecx
    b->dev = -1;
8010008e:	c7 40 04 ff ff ff ff 	movl   $0xffffffff,0x4(%eax)
    bcache.head.next->prev = b;
80100095:	8b 15 74 f5 10 80    	mov    0x8010f574,%edx
...
8010009e:	8d 90 18 02 00 00    	lea    0x218(%eax),%edx
    ...
    bcache.head.next->prev = b;
    bcache.head.next = b;
801000a4:	a3 74 f5 10 80       	mov    %eax,0x8010f574
...
//PAGEBREAK!
  ...
  bcache.head.next = &bcache.head;
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
801000a9:	81 fa 64 f5 10 80    	cmp    $0x8010f564,%edx
...
bget(uint dev, uint blockno)
{
  ...
  acquire(&bcache.lock);
801000cf:	68 60 b6 10 80       	push   $0x8010b660
...
801000dc:	8b 1d 74 f5 10 80    	mov    0x8010f574,%ebx
801000e2:	81 fb 64 f5 10 80    	cmp    $0x8010f564,%ebx
...
801000f3:	81 fb 64 f5 10 80    	cmp    $0x8010f564,%ebx
...
8010010e:	68 60 b6 10 80       	push   $0x8010b660
...
80100120:	8b 1d 70 f5 10 80    	mov    0x8010f570,%ebx
80100126:	81 fb 64 f5 10 80    	cmp    $0x8010f564,%ebx
8010012c:	75 0d                	jne    8010013b <bread+0x7b>
8010012e:	eb 5e                	jmp    8010018e <bread+0xce>
80100130:	8b 5b 0c             	mov    0xc(%ebx),%ebx
80100133:	81 fb 64 f5 10 80    	cmp    $0x8010f564,%ebx
...
80100149:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
      release(&bcache.lock);
8010014f:	68 60 b6 10 80       	push   $0x8010b660
...
8010017d:	89 03                	mov    %eax,(%ebx)
        release(&bcache.lock);
8010017f:	68 60 b6 10 80       	push   $0x8010b660
...
80100191:	68 e7 6f 10 80       	push   $0x80106fe7
...
801001c0:	68 f8 6f 10 80       	push   $0x80106ff8
...
801001e2:	68 60 b6 10 80       	push   $0x8010b660
...
801001fb:	89 50 10             	mov    %edx,0x10(%eax)
  b->next = bcache.head.next;
801001fe:	a1 74 f5 10 80       	mov    0x8010f574,%eax
  b->prev = &bcache.head;
80100203:	c7 43 0c 64 f5 10 80 	movl   $0x8010f564,0xc(%ebx)
...
8010020a:	89 43 10             	mov    %eax,0x10(%ebx)
  b->prev = &bcache.head;
  bcache.head.next->prev = b;
8010020d:	a1 74 f5 10 80       	mov    0x8010f574,%eax
80100212:	89 58 0c             	mov    %ebx,0xc(%eax)
  bcache.head.next = b;
80100215:	89 1d 74 f5 10 80    	mov    %ebx,0x8010f574
...
80100229:	c7 45 08 60 b6 10 80 	movl   $0x8010b660,0x8(%ebp)
}
...
8010023c:	68 ff 6f 10 80       	push   $0x80106fff
...
80100281:	a1 00 f8 10 80       	mov    0x8010f800,%eax
80100286:	3b 05 04 f8 10 80    	cmp    0x8010f804,%eax
...
80100298:	68 00 f8 10 80       	push   $0x8010f800
8010029d:	e8 1e 3b 00 00       	call   80103dc0 <sleep>
  ...
  while(n > 0){
    while(input.r == input.w){
801002a2:	a1 00 f8 10 80       	mov    0x8010f800,%eax
801002a7:	83 c4 10             	add    $0x10,%esp
801002aa:	3b 05 04 f8 10 80    	cmp    0x8010f804,%eax
...
801002eb:	89 15 00 f8 10 80    	mov    %edx,0x8010f800
801002f1:	89 c2                	mov    %eax,%edx
801002f3:	83 e2 7f             	and    $0x7f,%edx
801002f6:	0f be 92 80 f7 10 80 	movsbl -0x7fef0880(%edx),%edx
    if(c == C('D')){  // EOF
...
8010033e:	76 05                	jbe    80100345 <consoleread+0xf5>
        ...
        // caller gets a 0-byte result.
        input.r--;
80100340:	a3 00 f8 10 80       	mov    %eax,0x8010f800
...
80100373:	68 06 70 10 80       	push   $0x80107006
...
80100381:	e8 ba 02 00 00       	call   80100640 <cprintf>
  cprintf("\n");
80100386:	c7 04 24 26 75 10 80 	movl   $0x80107526,(%esp)
...
801003b0:	68 22 70 10 80       	push   $0x80107022
...
801003fa:	e8 91 56 00 00       	call   80105a90 <uartputc>
...
801004b3:	e8 d8 55 00 00       	call   80105a90 <uartputc>
801004b8:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
801004bf:	e8 cc 55 00 00       	call   80105a90 <uartputc>
801004c4:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
801004cb:	e8 c0 55 00 00       	call   80105a90 <uartputc>
...
80100520:	68 26 70 10 80       	push   $0x80107026
...
80100591:	0f b6 92 54 70 10 80 	movzbl -0x7fef8fac(%edx),%edx
  }while((x /= base) != 0);
...
80100765:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        s = "(null)";
80100768:	b8 39 70 10 80       	mov    $0x80107039,%eax
...
801007b8:	68 40 70 10 80       	push   $0x80107040
...
8010080f:	75 54                	jne    80100865 <consoleintr+0x95>
    ...
    case C('H'): case '\x7f':  // Backspace
      if(input.e != input.w){
80100811:	a1 08 f8 10 80       	mov    0x8010f808,%eax
80100816:	3b 05 04 f8 10 80    	cmp    0x8010f804,%eax
8010081c:	74 d2                	je     801007f0 <consoleintr+0x20>
        input.e--;
8010081e:	83 e8 01             	sub    $0x1,%eax
80100821:	a3 08 f8 10 80       	mov    %eax,0x8010f808
        consputc(BACKSPACE);
...
80100869:	a1 08 f8 10 80       	mov    0x8010f808,%eax
8010086e:	89 c2                	mov    %eax,%edx
80100870:	2b 15 00 f8 10 80    	sub    0x8010f800,%edx
...
80100885:	83 ff 0d             	cmp    $0xd,%edi
        input.buf[input.e++ % INPUT_BUF] = c;
80100888:	89 15 08 f8 10 80    	mov    %edx,0x8010f808
        consputc(BACKSPACE);
      }
      break;
    default:
...
80100896:	88 88 80 f7 10 80    	mov    %cl,-0x7fef0880(%eax)
        consputc(c);
...
801008b5:	a1 00 f8 10 80       	mov    0x8010f800,%eax
801008ba:	83 e8 80             	sub    $0xffffff80,%eax
801008bd:	39 05 08 f8 10 80    	cmp    %eax,0x8010f808
...
801008c9:	83 ec 0c             	sub    $0xc,%esp
      if(c != 0 && input.e-input.r < INPUT_BUF){
        ...
        if(c == '\n' || c == C('D') || input.e == input.r+INPUT_BUF){
          input.w = input.e;
801008cc:	a3 04 f8 10 80       	mov    %eax,0x8010f804
          wakeup(&input.r);
801008d1:	68 00 f8 10 80       	push   $0x8010f800
...
801008e8:	a1 08 f8 10 80       	mov    0x8010f808,%eax
801008ed:	39 05 04 f8 10 80    	cmp    %eax,0x8010f804
...
801008fa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        ...
        input.e--;
80100900:	a3 08 f8 10 80       	mov    %eax,0x8010f808
        consputc(BACKSPACE);
...
8010090a:	e8 c1 fa ff ff       	call   801003d0 <consputc>
    ...
    case C('U'):  // Kill line.
      while(input.e != input.w &&
8010090f:	a1 08 f8 10 80       	mov    0x8010f808,%eax
80100914:	3b 05 04 f8 10 80    	cmp    0x8010f804,%eax
...
80100925:	83 e2 7f             	and    $0x7f,%edx
    ...
    case C('U'):  // Kill line.
      while(input.e != input.w &&
80100928:	80 ba 80 f7 10 80 0a 	cmpb   $0xa,-0x7fef0880(%edx)
...
80100957:	e9 f4 36 00 00       	jmp    80104050 <procdump>
    ...
    default:
      if(c != 0 && input.e-input.r < INPUT_BUF){
        c = (c == '\r') ? '\n' : c;
        input.buf[input.e++ % INPUT_BUF] = c;
8010095c:	c6 80 80 f7 10 80 0a 	movb   $0xa,-0x7fef0880(%eax)
        consputc(c);
80100963:	b8 0a 00 00 00       	mov    $0xa,%eax
80100968:	e8 63 fa ff ff       	call   801003d0 <consputc>
8010096d:	a1 08 f8 10 80       	mov    0x8010f808,%eax
...
80100986:	68 49 70 10 80       	push   $0x80107049
...
consoleinit(void)
{
  ...
  devsw[CONSOLE].write = consolewrite;
8010099c:	c7 05 cc 01 11 80 e0 	movl   $0x801005e0,0x801101cc
801009a3:	05 10 80 
  devsw[CONSOLE].read = consoleread;
801009a6:	c7 05 c8 01 11 80 50 	movl   $0x80100250,0x801101c8
801009ad:	02 10 80 
  cons.locking = 1;
...
80100a4a:	75 cf                	jne    80100a1b <exec+0x4b>
  ...
  if((pgdir = setupkvm()) == 0)
80100a4c:	e8 ff 5d 00 00       	call   80106850 <setupkvm>
...
80100adc:	e8 ff 5f 00 00       	call   80106ae0 <allocuvm>
...
80100b12:	e8 09 5f 00 00       	call   80106a20 <loaduvm>
...
80100b31:	e8 da 60 00 00       	call   80106c10 <freevm>
...
80100b71:	e8 6a 5f 00 00       	call   80106ae0 <allocuvm>
...
80100b88:	e8 83 60 00 00       	call   80106c10 <freevm>
...
80100bbd:	e8 ce 60 00 00       	call   80106c90 <clearpteu>
  sp = sz;
...
80100c15:	e8 d6 61 00 00       	call   80106df0 <copyout>
...
80100c79:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  ...
  sp -= (3+argc+1) * 4;
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100c7f:	e8 6c 61 00 00       	call   80106df0 <copyout>
...
80100cf9:	e8 02 5c 00 00       	call   80106900 <switchuvm>
  freevm(oldpgdir);
80100cfe:	89 3c 24             	mov    %edi,(%esp)
80100d01:	e8 0a 5f 00 00       	call   80106c10 <freevm>
  return 0;
...
80100d26:	68 65 70 10 80       	push   $0x80107065
80100d2b:	68 20 f8 10 80       	push   $0x8010f820
...
80100d44:	bb 54 f8 10 80       	mov    $0x8010f854,%ebx
}
...
80100d49:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&ftable.lock);
80100d4c:	68 20 f8 10 80       	push   $0x8010f820
...
80100d63:	81 fb b4 01 11 80    	cmp    $0x801101b4,%ebx
...
80100d75:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
      release(&ftable.lock);
80100d7c:	68 20 f8 10 80       	push   $0x8010f820
...
80100d93:	68 20 f8 10 80       	push   $0x8010f820
...
80100db7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ftable.lock);
80100dba:	68 20 f8 10 80       	push   $0x8010f820
...
80100dd4:	89 43 04             	mov    %eax,0x4(%ebx)
  release(&ftable.lock);
80100dd7:	68 20 f8 10 80       	push   $0x8010f820
...
80100deb:	68 6c 70 10 80       	push   $0x8010706c
...
80100e09:	8b 7d 08             	mov    0x8(%ebp),%edi
  ...
  acquire(&ftable.lock);
80100e0c:	68 20 f8 10 80       	push   $0x8010f820
...
80100e2c:	74 1a                	je     80100e48 <fileclose+0x48>
    release(&ftable.lock);
80100e2e:	c7 45 08 20 f8 10 80 	movl   $0x8010f820,0x8(%ebp)
...
80100e5d:	8b 47 10             	mov    0x10(%edi),%eax
  ...
  f->type = FD_NONE;
  release(&ftable.lock);
80100e60:	68 20 f8 10 80       	push   $0x8010f820
    panic("fileclose");
  if(--f->ref > 0){
    release(&ftable.lock);
    return;
...
80100ec2:	68 74 70 10 80       	push   $0x80107074
...
80100fa2:	68 7e 70 10 80       	push   $0x8010707e
...
801010b4:	68 87 70 10 80       	push   $0x80107087
...
801010c1:	68 8d 70 10 80       	push   $0x8010708d
...
801010d9:	8b 0d 20 02 11 80    	mov    0x80110220,%ecx
// Blocks.
...
801010fc:	03 05 38 02 11 80    	add    0x80110238,%eax
...
8010110e:	a1 20 02 11 80       	mov    0x80110220,%eax
...
80101167:	39 05 20 02 11 80    	cmp    %eax,0x80110220
...
80101172:	68 97 70 10 80       	push   $0x80107097
...
801011ea:	bb 74 02 11 80       	mov    $0x80110274,%ebx
// Find the inode with number inum on device dev
// and return the in-memory copy. Does not lock
// the inode and does not read it from disk.
static struct inode*
...
801011f2:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  ...
  acquire(&icache.lock);
801011f5:	68 40 02 11 80       	push   $0x80110240
...
80101217:	81 fb 14 12 11 80    	cmp    $0x80111214,%ebx
...
80101235:	89 de                	mov    %ebx,%esi
  ...
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
    if(ip->ref > 0 && ip->dev == dev && ip->inum == inum){
      ip->ref++;
      release(&icache.lock);
80101237:	68 40 02 11 80       	push   $0x80110240
...
80101260:	81 fb 14 12 11 80    	cmp    $0x80111214,%ebx
...
80101283:	c7 46 0c 00 00 00 00 	movl   $0x0,0xc(%esi)
  release(&icache.lock);
8010128a:	68 40 02 11 80       	push   $0x80110240
...
801012a4:	68 ad 70 10 80       	push   $0x801070ad
...
8010135f:	68 bd 70 10 80       	push   $0x801070bd
...
801013bc:	68 20 02 11 80       	push   $0x80110220
...
801013ce:	03 15 38 02 11 80    	add    0x80110238,%edx
...
80101426:	68 d0 70 10 80       	push   $0x801070d0
...
80101436:	68 e3 70 10 80       	push   $0x801070e3
8010143b:	68 40 02 11 80       	push   $0x80110240
80101440:	e8 cb 2c 00 00       	call   80104110 <initlock>
  readsb(dev, &sb);
80101445:	58                   	pop    %eax
80101446:	5a                   	pop    %edx
80101447:	68 20 02 11 80       	push   $0x80110220
8010144c:	ff 75 08             	pushl  0x8(%ebp)
8010144f:	e8 1c ff ff ff       	call   80101370 <readsb>
  cprintf("sb: size %d nblocks %d ninodes %d nlog %d logstart %d\
80101454:	ff 35 38 02 11 80    	pushl  0x80110238
8010145a:	ff 35 34 02 11 80    	pushl  0x80110234
80101460:	ff 35 30 02 11 80    	pushl  0x80110230
80101466:	ff 35 2c 02 11 80    	pushl  0x8011022c
8010146c:	ff 35 28 02 11 80    	pushl  0x80110228
80101472:	ff 35 24 02 11 80    	pushl  0x80110224
80101478:	ff 35 20 02 11 80    	pushl  0x80110220
8010147e:	68 44 71 10 80       	push   $0x80107144
...
80101499:	83 3d 28 02 11 80 01 	cmpl   $0x1,0x80110228
//PAGEBREAK!
// Allocate a new inode with the given type on device dev.
// A free inode has a type of zero.
struct inode*
...
801014cf:	39 1d 28 02 11 80    	cmp    %ebx,0x80110228
...
801014df:	03 05 34 02 11 80    	add    0x80110234,%eax
...
80101543:	68 ea 70 10 80       	push   $0x801070ea
...
80101564:	03 05 34 02 11 80    	add    0x80110234,%eax
...
801015d7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&icache.lock);
801015da:	68 40 02 11 80       	push   $0x80110240
801015df:	e8 4c 2b 00 00       	call   80104130 <acquire>
  ip->ref++;
801015e4:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
801015e8:	c7 04 24 40 02 11 80 	movl   $0x80110240,(%esp)
...
8010161e:	68 40 02 11 80       	push   $0x80110240
...
8010163b:	68 40 02 11 80       	push   $0x80110240
...
80101656:	89 43 0c             	mov    %eax,0xc(%ebx)
  release(&icache.lock);
80101659:	68 40 02 11 80       	push   $0x80110240
...
80101681:	03 05 34 02 11 80    	add    0x80110234,%eax
...
801016ee:	68 02 71 10 80       	push   $0x80107102
...
80101703:	68 fc 70 10 80       	push   $0x801070fc
...
8010172e:	68 40 02 11 80       	push   $0x80110240
...
80101747:	c7 45 08 40 02 11 80 	movl   $0x80110240,0x8(%ebp)
}
...
8010175a:	68 11 71 10 80       	push   $0x80107111
...
80101779:	8b 75 08             	mov    0x8(%ebp),%esi
  acquire(&icache.lock);
8010177c:	68 40 02 11 80       	push   $0x80110240
...
801017be:	89 56 0c             	mov    %edx,0xc(%esi)
    release(&icache.lock);
801017c1:	68 40 02 11 80       	push   $0x80110240
...
8010181a:	e8 31 fd ff ff       	call   80101550 <iupdate>
    acquire(&icache.lock);
8010181f:	c7 04 24 40 02 11 80 	movl   $0x80110240,(%esp)
...
80101843:	89 46 08             	mov    %eax,0x8(%esi)
  release(&icache.lock);
80101846:	c7 45 08 40 02 11 80 	movl   $0x80110240,0x8(%ebp)
}
...
801018bd:	68 19 71 10 80       	push   $0x80107119
...
801019fa:	8b 04 c5 c0 01 11 80 	mov    -0x7feefe40(,%eax,8),%eax
...
80101b0a:	8b 04 c5 c4 01 11 80 	mov    -0x7feefe3c(,%eax,8),%eax
...
80101bfd:	68 35 71 10 80       	push   $0x80107135
...
80101c0a:	68 23 71 10 80       	push   $0x80107123
...
{
  acquire(&icache.lock);
80101c45:	68 40 02 11 80       	push   $0x80110240
80101c4a:	e8 e1 24 00 00       	call   80104130 <acquire>
  ip->ref++;
80101c4f:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101c53:	c7 04 24 40 02 11 80 	movl   $0x80110240,(%esp)
...
80101e6b:	68 35 71 10 80       	push   $0x80107135
...
80101f80:	68 a9 71 10 80       	push   $0x801071a9
...
80101f8d:	68 a0 71 10 80       	push   $0x801071a0
...
80101fa6:	68 bb 71 10 80       	push   $0x801071bb
...
80101fc1:	58                   	pop    %eax
80101fc2:	a1 40 19 11 80       	mov    0x80111940,%eax
80101fc7:	5a                   	pop    %edx
...
8010218e:	68 bf 71 10 80       	push   $0x801071bf
...
8010219b:	68 e8 71 10 80       	push   $0x801071e8
...
801021a8:	68 d3 71 10 80       	push   $0x801071d3
...
ioapicinit(void)
{
  ...
  if(!ismp)
801021c0:	a1 44 13 11 80       	mov    0x80111344,%eax
...
801021ce:	c7 05 14 12 11 80 00 	movl   $0xfec00000,0x80111214
801021d5:	00 c0 fe 
  ioapic->data = data;
}
...
801021e3:	00 00 00 
  return ioapic->data;
801021e6:	8b 15 14 12 11 80    	mov    0x80111214,%edx
...
801021ef:	c7 02 00 00 00 00    	movl   $0x0,(%edx)
  return ioapic->data;
801021f5:	8b 0d 14 12 11 80    	mov    0x80111214,%ecx
    return;
  ...
  if(id != ioapicid)
801021fb:	0f b6 15 40 13 11 80 	movzbl 0x80111340,%edx
...
80102217:	68 08 72 10 80       	push   $0x80107208
8010221c:	e8 1f e4 ff ff       	call   80100640 <cprintf>
80102221:	8b 0d 14 12 11 80    	mov    0x80111214,%ecx
...
80102240:	89 11                	mov    %edx,(%ecx)
  ioapic->data = data;
80102242:	8b 0d 14 12 11 80    	mov    0x80111214,%ecx
    cprintf("ioapicinit: id isn't equal to ioapicid; not a MP\n");
...
8010225e:	89 19                	mov    %ebx,(%ecx)
  ioapic->data = data;
80102260:	8b 0d 14 12 11 80    	mov    0x80111214,%ecx
...
{
  if(!ismp)
80102280:	8b 15 44 13 11 80    	mov    0x80111344,%edx
  }
}
...
{
  ioapic->reg = reg;
80102290:	8b 0d 14 12 11 80    	mov    0x80111214,%ecx
    return;
...
8010229d:	89 01                	mov    %eax,(%ecx)
  ioapic->data = data;
8010229f:	8b 0d 14 12 11 80    	mov    0x80111214,%ecx
}
...
801022ae:	89 01                	mov    %eax,(%ecx)
  ioapic->data = data;
801022b0:	a1 14 12 11 80       	mov    0x80111214,%eax
...
801022d2:	81 fb e8 40 11 80    	cmp    $0x801140e8,%ebx
...
801022f2:	e8 69 20 00 00       	call   80104360 <memset>
  ...
  if(kmem.use_lock)
801022f7:	8b 15 54 12 11 80    	mov    0x80111254,%edx
...
80102304:	a1 58 12 11 80       	mov    0x80111258,%eax
80102309:	89 03                	mov    %eax,(%ebx)
  kmem.freelist = r;
  if(kmem.use_lock)
8010230b:	a1 54 12 11 80       	mov    0x80111254,%eax
  ...
  r->next = kmem.freelist;
  kmem.freelist = r;
80102310:	89 1d 58 12 11 80    	mov    %ebx,0x80111258
  if(kmem.use_lock)
...
8010231f:	90                   	nop
  ...
  if(kmem.use_lock)
    release(&kmem.lock);
80102320:	c7 45 08 20 12 11 80 	movl   $0x80111220,0x8(%ebp)
}
...
80102333:	68 20 12 11 80       	push   $0x80111220
...
80102345:	68 3a 72 10 80       	push   $0x8010723a
...
801023ab:	68 40 72 10 80       	push   $0x80107240
801023b0:	68 20 12 11 80       	push   $0x80111220
...
kinit1(void *vstart, void *vend)
{
  initlock(&kmem.lock, "kmem");
  kmem.use_lock = 0;
801023c0:	c7 05 54 12 11 80 00 	movl   $0x0,0x80111254
801023c7:	00 00 00 
...
kinit2(void *vstart, void *vend)
{
  freerange(vstart, vend);
  kmem.use_lock = 1;
80102454:	c7 05 54 12 11 80 01 	movl   $0x1,0x80111254
8010245b:	00 00 00 
}
...
801024b3:	68 20 12 11 80       	push   $0x80111220
801024b8:	e8 73 1c 00 00       	call   80104130 <acquire>
  r = kmem.freelist;
801024bd:	8b 1d 58 12 11 80    	mov    0x80111258,%ebx
  if(r)
801024c3:	83 c4 10             	add    $0x10,%esp
801024c6:	a1 54 12 11 80       	mov    0x80111254,%eax
...
{
  if(!lapic)
801025d0:	a1 5c 12 11 80       	mov    0x8011125c,%eax
}
//PAGEBREAK!
...
801026ec:	74 4d                	je     8010273b <cpunum+0x6b>
  ...
  if (!lapic)
801026ee:	a1 5c 12 11 80       	mov    0x8011125c,%eax
...
801026f7:	8b 58 20             	mov    0x20(%eax),%ebx
  for (i = 0; i < ncpu; ++i) {
801026fa:	8b 35 40 19 11 80    	mov    0x80111940,%esi
  }
...
80102707:	0f b6 05 60 13 11 80 	movzbl 0x80111360,%eax
8010270e:	39 c3                	cmp    %eax,%ebx
80102710:	74 45                	je     80102757 <cpunum+0x87>
80102712:	ba 1c 14 11 80       	mov    $0x8011141c,%edx
...
80102746:	e8 f5 de ff ff       	call   80100640 <cprintf>
  ...
  if (!lapic)
8010274b:	a1 5c 12 11 80       	mov    0x8011125c,%eax
  // almost everything, including cprintf and panic, calls cpu,
  // often indirectly through acquire and release.
  if(readeflags()&FL_IF){
    static int n;
...
{
  if(lapic)
80102770:	a1 5c 12 11 80       	mov    0x8011125c,%eax
}
...
{
  lapic[index] = value;
801027de:	a1 5c 12 11 80       	mov    0x8011125c,%eax
...
80102a10:	8b 0d a8 12 11 80    	mov    0x801112a8,%ecx
...
80102a30:	a1 94 12 11 80       	mov    0x80111294,%eax
80102a35:	83 ec 08             	sub    $0x8,%esp
80102a38:	01 d8                	add    %ebx,%eax
80102a3a:	83 c0 01             	add    $0x1,%eax
80102a3d:	50                   	push   %eax
80102a3e:	ff 35 a4 12 11 80    	pushl  0x801112a4
80102a44:	e8 77 d6 ff ff       	call   801000c0 <bread>
80102a49:	89 c7                	mov    %eax,%edi
    struct buf *dbuf = bread(log.dev, log.lh.block[tail]); // read dst
80102a4b:	58                   	pop    %eax
80102a4c:	5a                   	pop    %edx
80102a4d:	ff 34 9d ac 12 11 80 	pushl  -0x7feeed54(,%ebx,4)
80102a54:	ff 35 a4 12 11 80    	pushl  0x801112a4
static void
install_trans(void)
{
  int tail;
...
80102a94:	39 1d a8 12 11 80    	cmp    %ebx,0x801112a8
...
80102ab7:	ff 35 94 12 11 80    	pushl  0x80111294
80102abd:	ff 35 a4 12 11 80    	pushl  0x801112a4
80102ac3:	e8 f8 d5 ff ff       	call   801000c0 <bread>
80102ac8:	89 c3                	mov    %eax,%ebx
  struct logheader *hb = (struct logheader *) (buf->data);
  int i;
  hb->n = log.lh.n;
80102aca:	a1 a8 12 11 80       	mov    0x801112a8,%eax
...
80102ad4:	89 43 18             	mov    %eax,0x18(%ebx)
  for (i = 0; i < log.lh.n; i++) {
80102ad7:	a1 a8 12 11 80       	mov    0x801112a8,%eax
80102adc:	85 c0                	test   %eax,%eax
80102ade:	7e 16                	jle    80102af6 <write_head+0x46>
    hb->block[i] = log.lh.block[i];
80102ae0:	8b 0c 95 ac 12 11 80 	mov    -0x7feeed54(,%edx,4),%ecx
...
80102aee:	39 15 a8 12 11 80    	cmp    %edx,0x801112a8
...
80102b1f:	68 60 12 11 80       	push   $0x80111260
...
80102b3b:	59                   	pop    %ecx
  ...
  log.size = sb.nlog;
  log.dev = dev;
80102b3c:	89 1d a4 12 11 80    	mov    %ebx,0x801112a4
  ...
  log.start = sb.logstart;
  log.size = sb.nlog;
80102b42:	89 15 98 12 11 80    	mov    %edx,0x80111298
    panic("initlog: too big logheader");
  ...
  readsb(dev, &sb);
  log.start = sb.logstart;
80102b48:	a3 94 12 11 80       	mov    %eax,0x80111294
...
read_head(void)
{
  ...
  int i;
  log.lh.n = lh->n;
80102b5d:	89 0d a8 12 11 80    	mov    %ecx,0x801112a8
  for (i = 0; i < log.lh.n; i++) {
...
80102b77:	89 8a a8 12 11 80    	mov    %ecx,-0x7feeed58(%edx)
{
  struct buf *buf = bread(log.dev, log.start);
  struct logheader *lh = (struct logheader *) (buf->data);
  int i;
...
80102b8a:	e8 81 fe ff ff       	call   80102a10 <install_trans>
  log.lh.n = 0;
80102b8f:	c7 05 a8 12 11 80 00 	movl   $0x0,0x801112a8
80102b96:	00 00 00 
...
80102bb3:	83 ec 14             	sub    $0x14,%esp
  acquire(&log.lock);
80102bb6:	68 60 12 11 80       	push   $0x80111260
...
80102bcb:	68 60 12 11 80       	push   $0x80111260
80102bd0:	68 60 12 11 80       	push   $0x80111260
...
begin_op(void)
{
  ...
  while(1){
    if(log.committing){
80102bdd:	a1 a0 12 11 80       	mov    0x801112a0,%eax
80102be2:	85 c0                	test   %eax,%eax
80102be4:	75 e2                	jne    80102bc8 <begin_op+0x18>
      sleep(&log, &log.lock);
    } else if(log.lh.n + (log.outstanding+1)*MAXOPBLOCKS > LOGSIZE){
80102be6:	a1 9c 12 11 80       	mov    0x8011129c,%eax
80102beb:	8b 15 a8 12 11 80    	mov    0x801112a8,%edx
...
80102bff:	83 ec 0c             	sub    $0xc,%esp
      ...
      log.outstanding += 1;
80102c02:	a3 9c 12 11 80       	mov    %eax,0x8011129c
      release(&log.lock);
80102c07:	68 60 12 11 80       	push   $0x80111260
...
80102c26:	83 ec 18             	sub    $0x18,%esp
  ...
  acquire(&log.lock);
80102c29:	68 60 12 11 80       	push   $0x80111260
80102c2e:	e8 fd 14 00 00       	call   80104130 <acquire>
  log.outstanding -= 1;
80102c33:	a1 9c 12 11 80       	mov    0x8011129c,%eax
  if(log.committing)
80102c38:	8b 1d a0 12 11 80    	mov    0x801112a0,%ebx
...
end_op(void)
{
  ...
  acquire(&log.lock);
  log.outstanding -= 1;
80102c46:	a3 9c 12 11 80       	mov    %eax,0x8011129c
  if(log.committing)
...
80102c59:	83 ec 0c             	sub    $0xc,%esp
  ...
  if(log.outstanding == 0){
    do_commit = 1;
    log.committing = 1;
80102c5c:	c7 05 a0 12 11 80 01 	movl   $0x1,0x801112a0
80102c63:	00 00 00 
}
...
80102c66:	31 db                	xor    %ebx,%ebx
  ...
  release(&log.lock);
80102c68:	68 60 12 11 80       	push   $0x80111260
...
{
  if (log.lh.n > 0) {
80102c72:	8b 0d a8 12 11 80    	mov    0x801112a8,%ecx
...
80102cec:	3b 1d a8 12 11 80    	cmp    0x801112a8,%ebx
...
80102cf9:	e8 12 fd ff ff       	call   80102a10 <install_trans>
    log.lh.n = 0;
80102cfe:	c7 05 a8 12 11 80 00 	movl   $0x0,0x801112a8
80102d05:	00 00 00 
...
80102d10:	68 60 12 11 80       	push   $0x80111260
80102d15:	e8 16 14 00 00       	call   80104130 <acquire>
    log.committing = 0;
    wakeup(&log);
80102d1a:	c7 04 24 60 12 11 80 	movl   $0x80111260,(%esp)
  if(do_commit){
    // call commit w/o holding locks, since not allowed
    // to sleep with locks.
    commit();
    acquire(&log.lock);
    log.committing = 0;
80102d21:	c7 05 a0 12 11 80 00 	movl   $0x0,0x801112a0
80102d28:	00 00 00 
    wakeup(&log);
80102d2b:	e8 30 12 00 00       	call   80103f60 <wakeup>
    release(&log.lock);
80102d30:	c7 04 24 60 12 11 80 	movl   $0x80111260,(%esp)
...
80102d53:	68 60 12 11 80       	push   $0x80111260
80102d58:	e8 03 12 00 00       	call   80103f60 <wakeup>
  }
  release(&log.lock);
80102d5d:	c7 04 24 60 12 11 80 	movl   $0x80111260,(%esp)
...
80102d97:	8b 15 a8 12 11 80    	mov    0x801112a8,%edx
//   modify bp->data[]
//   log_write(bp)
//   brelse(bp)
void
...
80102dc9:	68 60 12 11 80       	push   $0x80111260
80102dce:	e8 5d 13 00 00       	call   80104130 <acquire>
  for (i = 0; i < log.lh.n; i++) {
80102dd3:	8b 15 a8 12 11 80    	mov    0x801112a8,%edx
...
80102de4:	31 c0                	xor    %eax,%eax
    if (log.lh.block[i] == b->blockno)   // log absorbtion
80102de6:	3b 0d ac 12 11 80    	cmp    0x801112ac,%ecx
80102dec:	75 0b                	jne    80102df9 <log_write+0x69>
80102dee:	eb 38                	jmp    80102e28 <log_write+0x98>
80102df0:	39 0c 85 ac 12 11 80 	cmp    %ecx,-0x7feeed54(,%eax,4)
...
80102e00:	89 0c 95 ac 12 11 80 	mov    %ecx,-0x7feeed54(,%edx,4)
  if (i == log.lh.n)
    log.lh.n++;
80102e07:	83 c2 01             	add    $0x1,%edx
80102e0a:	89 15 a8 12 11 80    	mov    %edx,0x801112a8
  b->flags |= B_DIRTY; // prevent eviction
80102e10:	83 0b 04             	orl    $0x4,(%ebx)
  release(&log.lock);
80102e13:	c7 45 08 60 12 11 80 	movl   $0x80111260,0x8(%ebp)
}
...
80102e24:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  log.lh.block[i] = b->blockno;
80102e28:	89 0c 85 ac 12 11 80 	mov    %ecx,-0x7feeed54(,%eax,4)
80102e2f:	eb df                	jmp    80102e10 <log_write+0x80>
80102e31:	8b 43 08             	mov    0x8(%ebx),%eax
80102e34:	a3 ac 12 11 80       	mov    %eax,0x801112ac
  if (i == log.lh.n)
...
80102e79:	e8 52 28 00 00       	call   801056d0 <idtinit>
...
80102ea6:	e8 35 3a 00 00       	call   801068e0 <switchkvm>
  seginit();
80102eab:	e8 50 38 00 00       	call   80106700 <seginit>
  lapicinit();
...
80102f16:	e8 b5 2a 00 00       	call   801059d0 <uartinit>
  pinit();         // process table
80102f1b:	e8 00 09 00 00       	call   80103820 <pinit>
  tvinit();        // trap vectors
80102f20:	e8 0b 27 00 00       	call   80105630 <tvinit>
  binit();         // buffer cache
...
80102f2f:	e8 6c f0 ff ff       	call   80101fa0 <ideinit>
  if(!ismp)
80102f34:	8b 1d 44 13 11 80    	mov    0x80111344,%ebx
80102f3a:	83 c4 10             	add    $0x10,%esp
80102f3d:	85 db                	test   %ebx,%ebx
80102f3f:	0f 84 cf 00 00 00    	je     80103014 <main+0x154>
...
80102f48:	bb 60 13 11 80       	mov    $0x80111360,%ebx
...
80102f5c:	e8 af 14 00 00       	call   80104410 <memmove>
  ...
  for(c = cpus; c < cpus+ncpu; c++){
80102f61:	69 05 40 19 11 80 bc 	imul   $0xbc,0x80111940,%eax
80102f68:	00 00 00 
80102f6b:	83 c4 10             	add    $0x10,%esp
80102f6e:	05 60 13 11 80       	add    $0x80111360,%eax
...
80102f8b:	05 60 13 11 80       	add    $0x80111360,%eax
...
80102fd8:	74 f6                	je     80102fd0 <main+0x110>
  ...
  for(c = cpus; c < cpus+ncpu; c++){
80102fda:	69 05 40 19 11 80 bc 	imul   $0xbc,0x80111940,%eax
80102fe1:	00 00 00 
80102fe4:	81 c3 bc 00 00 00    	add    $0xbc,%ebx
80102fea:	05 60 13 11 80       	add    $0x80111360,%eax
...
80103005:	e8 36 08 00 00       	call   80103840 <userinit>
  lock_init();     // for lock-related system call
8010300a:	e8 81 3e 00 00       	call   80106e90 <lock_init>
  mpmain();        // finish this processor's setup
8010300f:	e8 4c fe ff ff       	call   80102e60 <mpmain>
  tvinit();        // trap vectors
  binit();         // buffer cache
  fileinit();      // file table
  ideinit();       // disk
  if(!ismp)
    timerinit();   // uniprocessor timer
80103014:	e8 b7 25 00 00       	call   801055d0 <timerinit>
80103019:	e9 27 ff ff ff       	jmp    80102f45 <main+0x85>
...
80103162:	74 6f                	je     801031d3 <mpinit+0x133>
    return;
  ismp = 1;
80103164:	c7 05 44 13 11 80 01 	movl   $0x1,0x80111344
8010316b:	00 00 00 
  lapic = (uint*)conf->lapicaddr;
8010316e:	8b 83 24 00 00 80    	mov    -0x7fffffdc(%ebx),%eax
80103174:	a3 5c 12 11 80       	mov    %eax,0x8011125c
...
801031ad:	77 e1                	ja     80103190 <mpinit+0xf0>
  ...
  if(!ismp){
801031af:	a1 44 13 11 80       	mov    0x80111344,%eax
801031b4:	85 c0                	test   %eax,%eax
801031b6:	75 78                	jne    80103230 <mpinit+0x190>
    // Didn't like what we found; fall back to no MP.
    ncpu = 1;
801031b8:	c7 05 40 19 11 80 01 	movl   $0x1,0x80111940
801031bf:	00 00 00 
    lapic = 0;
801031c2:	c7 05 5c 12 11 80 00 	movl   $0x0,0x8011125c
801031c9:	00 00 00 
    ioapicid = 0;
801031cc:	c6 05 40 13 11 80 00 	movb   $0x0,0x80111340
...
801031dc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  for(p=(uchar*)(conf+1), e=(uchar*)conf+conf->length; p<e; ){
    ...
    case MPPROC:
      ...
      if(ncpu < NCPU) {
801031e0:	8b 15 40 19 11 80    	mov    0x80111940,%edx
...
801031f8:	89 15 40 19 11 80    	mov    %edx,0x80111940
  for(p=(uchar*)(conf+1), e=(uchar*)conf+conf->length; p<e; ){
    switch(*p){
    case MPPROC:
      proc = (struct mpproc*)p;
      if(ncpu < NCPU) {
        cpus[ncpu].apicid = proc->apicid;  // apicid may differ from ncpu
801031fe:	88 9f 60 13 11 80    	mov    %bl,-0x7feeeca0(%edi)
        ncpu++;
      }
...
80103214:	83 c0 08             	add    $0x8,%eax
    ...
    case MPIOAPIC:
      ioapic = (struct mpioapic*)p;
      ioapicid = ioapic->apicno;
80103217:	88 15 40 13 11 80    	mov    %dl,0x80111340
      p += sizeof(struct mpioapic);
      continue;
...
8010321f:	90                   	nop
    ...
    default:
      ismp = 0;
80103220:	c7 05 44 13 11 80 00 	movl   $0x0,0x80111344
80103227:	00 00 00 
      break;
...
80103744:	bb 94 19 11 80       	mov    $0x80111994,%ebx
// state required to run in the kernel.
// Otherwise return 0.
// Must hold ptable.lock.
static struct proc*
...
80103753:	81 fb 94 38 11 80    	cmp    $0x80113894,%ebx
...
80103794:	89 53 18             	mov    %edx,0x18(%ebx)
  ...
  sp -= 4;
  *(uint*)sp = (uint)trapret;
80103797:	c7 40 14 1e 56 10 80 	movl   $0x8010561e,0x14(%eax)
...
801037d3:	83 ec 14             	sub    $0x14,%esp
  ...
  release(&ptable.lock);
801037d6:	68 60 19 11 80       	push   $0x80111960
...
80103826:	68 4d 75 10 80       	push   $0x8010754d
8010382b:	68 60 19 11 80       	push   $0x80111960
...
80103844:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&ptable.lock);
80103847:	68 60 19 11 80       	push   $0x80111960
...
8010385d:	e8 ee 2f 00 00       	call   80106850 <setupkvm>
...
8010387e:	e8 1d 31 00 00       	call   801069a0 <inituvm>
  p->sz = PGSIZE;
...
801038ec:	68 6d 75 10 80       	push   $0x8010756d
801038f1:	50                   	push   %eax
801038f2:	e8 69 0c 00 00       	call   80104560 <safestrcpy>
  p->cwd = namei("/");
801038f7:	c7 04 24 76 75 10 80 	movl   $0x80107576,(%esp)
...
8010390a:	89 43 68             	mov    %eax,0x68(%ebx)
  ...
  release(&ptable.lock);
8010390d:	c7 04 24 60 19 11 80 	movl   $0x80111960,(%esp)
...
80103924:	68 54 75 10 80       	push   $0x80107554
...
80103951:	e8 8a 31 00 00       	call   80106ae0 <allocuvm>
...
80103970:	e8 8b 2f 00 00       	call   80106900 <switchuvm>
  return 0;
...
8010398c:	e8 4f 32 00 00       	call   80106be0 <deallocuvm>
...
801039a6:	83 ec 18             	sub    $0x18,%esp
  ...
  acquire(&ptable.lock);
801039a9:	68 60 19 11 80       	push   $0x80111960
...
801039d3:	e8 e8 32 00 00       	call   80106cc0 <copyuvm>
...
80103a70:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  ...
  release(&ptable.lock);
80103a77:	c7 04 24 60 19 11 80 	movl   $0x80111960,(%esp)
...
80103a93:	68 60 19 11 80       	push   $0x80111960
...
80103ab9:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
    release(&ptable.lock);
80103ac0:	c7 04 24 60 19 11 80 	movl   $0x80111960,(%esp)
...
80103af1:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103af4:	bb 94 19 11 80       	mov    $0x80111994,%ebx
  for(;;){
    // Enable interrupts on this processor.
    sti();
    ...
    // Loop over process table looking for process to run.
    acquire(&ptable.lock);
80103af9:	68 60 19 11 80       	push   $0x80111960
...
80103b13:	81 fb 94 38 11 80    	cmp    $0x80113894,%ebx
...
80103b2c:	83 c3 7c             	add    $0x7c,%ebx
      ...
      proc = p;
      switchuvm(p);
80103b2f:	e8 cc 2d 00 00       	call   80106900 <switchuvm>
      p->state = RUNNING;
...
80103b4a:	e8 6c 0a 00 00       	call   801045bb <swtch>
      switchkvm();
80103b4f:	e8 8c 2d 00 00       	call   801068e0 <switchkvm>
...
80103b54:	83 c4 10             	add    $0x10,%esp
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103b57:	81 fb 94 38 11 80    	cmp    $0x80113894,%ebx
      swtch(&cpu->scheduler, p->context);
      switchkvm();
...
80103b73:	68 60 19 11 80       	push   $0x80111960
...
80103b97:	68 60 19 11 80       	push   $0x80111960
...
80103bf7:	68 78 75 10 80       	push   $0x80107578
...
80103c04:	68 a4 75 10 80       	push   $0x801075a4
...
80103c11:	68 96 75 10 80       	push   $0x80107596
...
80103c1e:	68 8a 75 10 80       	push   $0x8010758a
...
80103c9f:	c7 40 68 00 00 00 00 	movl   $0x0,0x68(%eax)
  ...
  acquire(&ptable.lock);
80103ca6:	c7 04 24 60 19 11 80 	movl   $0x80111960,(%esp)
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103cbc:	b8 94 19 11 80       	mov    $0x80111994,%eax
  proc->cwd = 0;
...
80103cd3:	3d 94 38 11 80       	cmp    $0x80113894,%eax
...
80103cef:	3d 94 38 11 80       	cmp    $0x80113894,%eax
...
80103cfc:	ba 94 19 11 80       	mov    $0x80111994,%edx
...
80103d0b:	81 fa 94 38 11 80    	cmp    $0x80113894,%edx
...
80103d21:	b8 94 19 11 80       	mov    $0x80111994,%eax
...
80103d33:	3d 94 38 11 80       	cmp    $0x80113894,%eax
...
80103d5d:	68 c5 75 10 80       	push   $0x801075c5
...
80103d6a:	68 b8 75 10 80       	push   $0x801075b8
...
80103d86:	68 60 19 11 80       	push   $0x80111960
...
80103d9d:	e8 ee fd ff ff       	call   80103b90 <sched>
  release(&ptable.lock);
80103da2:	c7 04 24 60 19 11 80 	movl   $0x80111960,(%esp)
...
80103de1:	81 fb 60 19 11 80    	cmp    $0x80111960,%ebx
80103de7:	74 57                	je     80103e40 <sleep+0x80>
    acquire(&ptable.lock);  //DOC: sleeplock1
80103de9:	83 ec 0c             	sub    $0xc,%esp
80103dec:	68 60 19 11 80       	push   $0x80111960
...
80103e19:	c7 40 20 00 00 00 00 	movl   $0x0,0x20(%eax)
  ...
  if(lk != &ptable.lock){  //DOC: sleeplock2
    release(&ptable.lock);
80103e20:	c7 04 24 60 19 11 80 	movl   $0x80111960,(%esp)
...
80103e66:	68 d7 75 10 80       	push   $0x801075d7
...
80103e73:	68 d1 75 10 80       	push   $0x801075d1
...
80103e88:	68 60 19 11 80       	push   $0x80111960
...
80103ec1:	ba 01 00 00 00       	mov    $0x1,%edx
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ec6:	81 fb 94 38 11 80    	cmp    $0x80113894,%ebx
...
80103ede:	68 60 19 11 80       	push   $0x80111960
...
80103f00:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103f07:	e8 04 2d 00 00       	call   80106c10 <freevm>
        p->pid = 0;
...
80103f25:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103f2c:	c7 04 24 60 19 11 80 	movl   $0x80111960,(%esp)
...
80103f47:	68 60 19 11 80       	push   $0x80111960
...
80103f67:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.lock);
80103f6a:	68 60 19 11 80       	push   $0x80111960
...
80103f9f:	3d 94 38 11 80       	cmp    $0x80113894,%eax
...
wakeup(void *chan)
{
  ...
  wakeup1(chan);
  release(&ptable.lock);
80103fa6:	c7 45 08 60 19 11 80 	movl   $0x80111960,0x8(%ebp)
}
...
80103fff:	68 60 19 11 80       	push   $0x80111960
...
8010402b:	68 60 19 11 80       	push   $0x80111960
...
80104059:	bb 00 1a 11 80       	mov    $0x80111a00,%ebx
...
8010406b:	68 26 75 10 80       	push   $0x80107526
...
80104078:	83 c3 7c             	add    $0x7c,%ebx
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010407b:	81 fb 00 39 11 80    	cmp    $0x80113900,%ebx
...
8010408e:	83 f8 05             	cmp    $0x5,%eax
      ...
      state = "???";
80104091:	ba e8 75 10 80       	mov    $0x801075e8,%edx
  uint pc[10];
...
80104098:	8b 14 85 20 76 10 80 	mov    -0x7fef89e0(,%eax,4),%edx
      state = states[p->state];
    else
      state = "???";
8010409f:	b8 e8 75 10 80       	mov    $0x801075e8,%eax
...
801040ae:	68 ec 75 10 80       	push   $0x801075ec
...
801040ed:	68 22 70 10 80       	push   $0x80107022
...
801041eb:	68 38 76 10 80       	push   $0x80107638
...
801042ef:	68 57 76 10 80       	push   $0x80107657
...
801042fc:	68 40 76 10 80       	push   $0x80107640
...
8010432e:	68 5e 76 10 80       	push   $0x8010765e
...
80104760 <syscall>:
[SYS_unlock]  sys_unlock, //for lock
};
...
8010477c:	8b 0c 85 a0 76 10 80 	mov    -0x7fef8960(,%eax,4),%ecx
...
801047a0:	68 66 76 10 80       	push   $0x80107666
...
80104914:	68 1c 77 10 80       	push   $0x8010771c
...
8010492c:	68 1b 77 10 80       	push   $0x8010771b
...
80104941:	68 0f 77 10 80       	push   $0x8010770f
...
8010494e:	68 1e 77 10 80       	push   $0x8010771e
...
8010495b:	68 00 77 10 80       	push   $0x80107700
...
80104a65:	e8 26 fc ff ff       	call   80104690 <argptr>
...
80104abd:	e8 8e fb ff ff       	call   80104650 <argint>
...
80104ad5:	e8 b6 fb ff ff       	call   80104690 <argptr>
...
80104b7f:	e8 0c fb ff ff       	call   80104690 <argptr>
...
80104bbf:	e8 1c fb ff ff       	call   801046e0 <argstr>
...
80104bd8:	e8 03 fb ff ff       	call   801046e0 <argstr>
...
80104be2:	0f 88 e2 00 00 00    	js     80104cca <sys_link+0x11a>
  ...
  begin_op();
80104be8:	e8 c3 df ff ff       	call   80102bb0 <begin_op>
  if((ip = namei(old)) == 0){
...
80104c7b:	e8 f0 ca ff ff       	call   80101770 <iput>
  ...
  end_op();
80104c80:	e8 9b df ff ff       	call   80102c20 <end_op>
...
80104cbd:	e8 0e cc ff ff       	call   801018d0 <iunlockput>
  end_op();
80104cc2:	e8 59 df ff ff       	call   80102c20 <end_op>
  return -1;
...
80104ce4:	e8 e7 cb ff ff       	call   801018d0 <iunlockput>
    end_op();
80104ce9:	e8 32 df ff ff       	call   80102c20 <end_op>
    return -1;
...
80104cf6:	eb 92                	jmp    80104c8a <sys_link+0xda>
  ...
  if((ip = namei(old)) == 0){
    end_op();
80104cf8:	e8 23 df ff ff       	call   80102c20 <end_op>
    return -1;
...
80104d1f:	e8 bc f9 ff ff       	call   801046e0 <argstr>
...
80104d2f:	8d 5d ca             	lea    -0x36(%ebp),%ebx
  ...
  begin_op();
80104d32:	e8 79 de ff ff       	call   80102bb0 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
...
80104d5d:	58                   	pop    %eax
80104d5e:	5a                   	pop    %edx
80104d5f:	68 1c 77 10 80       	push   $0x8010771c
...
80104d78:	68 1b 77 10 80       	push   $0x8010771b
...
80104dd2:	e8 89 f5 ff ff       	call   80104360 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
80104e17:	e8 b4 ca ff ff       	call   801018d0 <iunlockput>
  ...
  end_op();
80104e1c:	e8 ff dd ff ff       	call   80102c20 <end_op>
...
80104eb6:	e9 6b ff ff ff       	jmp    80104e26 <sys_unlink+0x116>
  ...
  if((dp = nameiparent(path, name)) == 0){
    end_op();
80104ebb:	e8 60 dd ff ff       	call   80102c20 <end_op>
    return -1;
...
80104ecd:	68 40 77 10 80       	push   $0x80107740
...
80104eda:	68 52 77 10 80       	push   $0x80107752
...
80104ee7:	68 2e 77 10 80       	push   $0x8010772e
...
80104f0f:	e8 cc f7 ff ff       	call   801046e0 <argstr>
...
80104f28:	e8 23 f7 ff ff       	call   80104650 <argint>
...
80104fb0:	e8 1b c9 ff ff       	call   801018d0 <iunlockput>
    end_op();
80104fb5:	e8 66 dc ff ff       	call   80102c20 <end_op>
    return -1;
...
8010509f:	e8 2c c8 ff ff       	call   801018d0 <iunlockput>
  end_op();
801050a4:	e8 77 db ff ff       	call   80102c20 <end_op>
  return 0;
...
801050e9:	e8 62 f5 ff ff       	call   80104650 <argint>
  struct inode *ip;
  char *path;
  int major, minor;
...
801050fe:	e8 4d f5 ff ff       	call   80104650 <argint>
  char *path;
  int major, minor;
...
8010512e:	e8 9d c7 ff ff       	call   801018d0 <iunlockput>
  end_op();
80105133:	e8 e8 da ff ff       	call   80102c20 <end_op>
  return 0;
...
8010513f:	90                   	nop
  ...
  if((argstr(0, &path)) < 0 ||
     ...
     (ip = create(path, T_DEV, major, minor)) == 0){
    end_op();
80105140:	e8 db da ff ff       	call   80102c20 <end_op>
    return -1;
...
801051d4:	e8 f7 c6 ff ff       	call   801018d0 <iunlockput>
    end_op();
801051d9:	e8 42 da ff ff       	call   80102c20 <end_op>
    return -1;
...
80105215:	e8 c6 f4 ff ff       	call   801046e0 <argstr>
...
8010522d:	e8 1e f4 ff ff       	call   80104650 <argint>
...
80105258:	e8 03 f1 ff ff       	call   80104360 <memset>
...
8010526e:	e8 5d f3 ff ff       	call   801045d0 <fetchint>
...
80105289:	e8 72 f3 ff ff       	call   80104600 <fetchstr>
...
801052f1:	e8 9a f3 ff ff       	call   80104690 <argptr>
...
80105308:	e8 43 e0 ff ff       	call   80103350 <pipealloc>
...
{
  return fork();
801053a4:	e9 f7 e5 ff ff       	jmp    801039a0 <fork>
...
801053b3:	83 ec 08             	sub    $0x8,%esp
  exit();
801053b6:	e8 75 e8 ff ff       	call   80103c30 <exit>
...
{
  return wait();
801053c4:	e9 b7 ea ff ff       	jmp    80103e80 <wait>
...
801053dc:	e8 6f f2 ff ff       	call   80104650 <argint>
...
801053ee:	e8 cd eb ff ff       	call   80103fc0 <kill>
...
8010542d:	e8 1e f2 ff ff       	call   80104650 <argint>
80105432:	83 c4 10             	add    $0x10,%esp
80105435:	85 c0                	test   %eax,%eax
80105437:	78 27                	js     80105460 <sys_sbrk+0x40>
    return -1;
  addr = proc->sz;
...
8010543f:	83 ec 0c             	sub    $0xc,%esp
  ...
  if(argint(0, &n) < 0)
    return -1;
  addr = proc->sz;
80105442:	8b 18                	mov    (%eax),%ebx
  if(growproc(n) < 0)
80105444:	ff 75 f4             	pushl  -0xc(%ebp)
80105447:	e8 e4 e4 ff ff       	call   80103930 <growproc>
8010544c:	83 c4 10             	add    $0x10,%esp
8010544f:	85 c0                	test   %eax,%eax
80105451:	78 0d                	js     80105460 <sys_sbrk+0x40>
    return -1;
  return addr;
...
80105465:	eb ee                	jmp    80105455 <sys_sbrk+0x35>
...
8010547d:	e8 ce f1 ff ff       	call   80104650 <argint>
80105482:	83 c4 10             	add    $0x10,%esp
80105485:	85 c0                	test   %eax,%eax
80105487:	0f 88 8a 00 00 00    	js     80105517 <sys_sleep+0xa7>
    return -1;
  acquire(&tickslock);
8010548d:	83 ec 0c             	sub    $0xc,%esp
80105490:	68 a0 38 11 80       	push   $0x801138a0
80105495:	e8 96 ec ff ff       	call   80104130 <acquire>
  ticks0 = ticks;
...
8010549d:	83 c4 10             	add    $0x10,%esp
  ...
  acquire(&tickslock);
  ticks0 = ticks;
801054a0:	8b 1d e0 40 11 80    	mov    0x801140e0,%ebx
  while(ticks - ticks0 < n){
801054a6:	85 d2                	test   %edx,%edx
801054a8:	75 27                	jne    801054d1 <sys_sleep+0x61>
801054aa:	eb 54                	jmp    80105500 <sys_sleep+0x90>
...
801054b3:	68 a0 38 11 80       	push   $0x801138a0
801054b8:	68 e0 40 11 80       	push   $0x801140e0
801054bd:	e8 fe e8 ff ff       	call   80103dc0 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801054c2:	a1 e0 40 11 80       	mov    0x801140e0,%eax
...
801054d7:	8b 40 24             	mov    0x24(%eax),%eax
801054da:	85 c0                	test   %eax,%eax
801054dc:	74 d2                	je     801054b0 <sys_sleep+0x40>
      release(&tickslock);
801054de:	83 ec 0c             	sub    $0xc,%esp
801054e1:	68 a0 38 11 80       	push   $0x801138a0
801054e6:	e8 25 ee ff ff       	call   80104310 <release>
      return -1;
...
80105503:	68 a0 38 11 80       	push   $0x801138a0
80105508:	e8 03 ee ff ff       	call   80104310 <release>
  return 0;
...
8010551c:	eb d5                	jmp    801054f3 <sys_sleep+0x83>
...
80105524:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105527:	68 a0 38 11 80       	push   $0x801138a0
8010552c:	e8 ff eb ff ff       	call   80104130 <acquire>
  xticks = ticks;
80105531:	8b 1d e0 40 11 80    	mov    0x801140e0,%ebx
  release(&tickslock);
80105537:	c7 04 24 a0 38 11 80 	movl   $0x801138a0,(%esp)
8010553e:	e8 cd ed ff ff       	call   80104310 <release>
  return xticks;
}
...
8010555c:	e8 ef f0 ff ff       	call   80104650 <argint>
80105561:	83 c4 10             	add    $0x10,%esp
80105564:	85 c0                	test   %eax,%eax
80105566:	78 18                	js     80105580 <sys_lock+0x30>
    return -1;
  }
  return lock(lkid);
80105568:	83 ec 0c             	sub    $0xc,%esp
8010556b:	ff 75 f4             	pushl  -0xc(%ebp)
8010556e:	e8 7d 19 00 00       	call   80106ef0 <lock>
...
8010559c:	e8 af f0 ff ff       	call   80104650 <argint>
801055a1:	83 c4 10             	add    $0x10,%esp
801055a4:	85 c0                	test   %eax,%eax
801055a6:	78 18                	js     801055c0 <sys_unlock+0x30>
    return -1;
  return unlock(lkid);
801055a8:	83 ec 0c             	sub    $0xc,%esp
801055ab:	ff 75 f4             	pushl  -0xc(%ebp)
801055ae:	e8 bd 19 00 00       	call   80106f70 <unlock>
...
{
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
801055d1:	ba 43 00 00 00       	mov    $0x43,%edx
801055d6:	b8 34 00 00 00       	mov    $0x34,%eax
801055db:	89 e5                	mov    %esp,%ebp
801055dd:	83 ec 14             	sub    $0x14,%esp
801055e0:	ee                   	out    %al,(%dx)
801055e1:	ba 40 00 00 00       	mov    $0x40,%edx
801055e6:	b8 9c ff ff ff       	mov    $0xffffff9c,%eax
801055eb:	ee                   	out    %al,(%dx)
801055ec:	b8 2e 00 00 00       	mov    $0x2e,%eax
801055f1:	ee                   	out    %al,(%dx)
...
801055f4:	e8 87 dc ff ff       	call   80103280 <picenable>
}
...
801055ff:	06                   	push   %es
  pushl %fs
80105600:	0f a0                	push   %fs
  pushl %gs
80105602:	0f a8                	push   %gs
  pushal
80105604:	60                   	pusha  
  
  # Set up data and per-cpu segments.
  movw $(SEG_KDATA<<3), %ax
80105605:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105609:	8e d8                	mov    %eax,%ds
  movw %ax, %es
8010560b:	8e c0                	mov    %eax,%es
  movw $(SEG_KCPU<<3), %ax
8010560d:	66 b8 18 00          	mov    $0x18,%ax
  movw %ax, %fs
80105611:	8e e0                	mov    %eax,%fs
  movw %ax, %gs
80105613:	8e e8                	mov    %eax,%gs

  # Call trap(tf), where tf=%esp
  pushl %esp
80105615:	54                   	push   %esp
  call trap
80105616:	e8 e5 00 00 00       	call   80105700 <trap>
  addl $4, %esp
8010561b:	83 c4 04             	add    $0x4,%esp
...
8010561e:	61                   	popa   
  popl %gs
8010561f:	0f a9                	pop    %gs
  popl %fs
80105621:	0f a1                	pop    %fs
  popl %es
80105623:	07                   	pop    %es
  popl %ds
80105624:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80105625:	83 c4 08             	add    $0x8,%esp
  iret
80105628:	cf                   	iret   
...
80105638:	8b 14 85 0c a0 10 80 	mov    -0x7fef5ff4(,%eax,4),%edx
8010563f:	b9 08 00 00 00       	mov    $0x8,%ecx
80105644:	c6 04 c5 e4 38 11 80 	movb   $0x0,-0x7feec71c(,%eax,8)
8010564b:	00 
8010564c:	66 89 0c c5 e2 38 11 	mov    %cx,-0x7feec71e(,%eax,8)
80105653:	80 
80105654:	c6 04 c5 e5 38 11 80 	movb   $0x8e,-0x7feec71b(,%eax,8)
8010565b:	8e 
8010565c:	66 89 14 c5 e0 38 11 	mov    %dx,-0x7feec720(,%eax,8)
80105663:	80 
80105664:	c1 ea 10             	shr    $0x10,%edx
80105667:	66 89 14 c5 e6 38 11 	mov    %dx,-0x7feec71a(,%eax,8)
8010566e:	80 
void
tvinit(void)
{
...
80105681:	83 ec 10             	sub    $0x10,%esp
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105684:	a1 0c a1 10 80       	mov    0x8010a10c,%eax

  initlock(&tickslock, "time");
80105689:	68 61 77 10 80       	push   $0x80107761
8010568e:	68 a0 38 11 80       	push   $0x801138a0
{
  int i;
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105693:	66 89 15 e2 3a 11 80 	mov    %dx,0x80113ae2
8010569a:	c6 05 e4 3a 11 80 00 	movb   $0x0,0x80113ae4
801056a1:	66 a3 e0 3a 11 80    	mov    %ax,0x80113ae0
801056a7:	c1 e8 10             	shr    $0x10,%eax
801056aa:	c6 05 e5 3a 11 80 ef 	movb   $0xef,0x80113ae5
801056b1:	66 a3 e6 3a 11 80    	mov    %ax,0x80113ae6

  initlock(&tickslock, "time");
801056b7:	e8 54 ea ff ff       	call   80104110 <initlock>
}
...
801056db:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801056df:	b8 e0 38 11 80       	mov    $0x801138e0,%eax
...
80105712:	0f 84 f8 00 00 00    	je     80105810 <trap+0x110>
    if(proc->killed)
      exit();
    return;
  }
...
8010571e:	77 68                	ja     80105788 <trap+0x88>
80105720:	ff 24 85 08 78 10 80 	jmp    *-0x7fef87f8(,%eax,4)
80105727:	89 f6                	mov    %esi,%esi
80105729:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  case T_IRQ0 + IRQ_TIMER:
    if(cpunum() == 0){
80105730:	e8 9b cf ff ff       	call   801026d0 <cpunum>
80105735:	85 c0                	test   %eax,%eax
80105737:	0f 84 b3 01 00 00    	je     801058f0 <trap+0x1f0>
    kbdintr();
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_COM1:
    uartintr();
    lapiceoi();
8010573d:	e8 2e d0 ff ff       	call   80102770 <lapiceoi>
  }
...
8010574a:	74 2d                	je     80105779 <trap+0x79>
8010574c:	8b 50 24             	mov    0x24(%eax),%edx
8010574f:	85 d2                	test   %edx,%edx
80105751:	0f 85 86 00 00 00    	jne    801057dd <trap+0xdd>
    exit();
...
8010575b:	0f 84 ef 00 00 00    	je     80105850 <trap+0x150>
    yield();
...
80105781:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
80105788:	65 8b 0d 04 00 00 00 	mov    %gs:0x4,%ecx
8010578f:	85 c9                	test   %ecx,%ecx
80105791:	0f 84 8d 01 00 00    	je     80105924 <trap+0x224>
80105797:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
8010579b:	0f 84 83 01 00 00    	je     80105924 <trap+0x224>
...
801057a4:	8b 73 38             	mov    0x38(%ebx),%esi
801057a7:	e8 24 cf ff ff       	call   801026d0 <cpunum>
...
801057b6:	ff 73 34             	pushl  0x34(%ebx)
801057b9:	ff 73 30             	pushl  0x30(%ebx)
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpunum(), tf->eip,
801057bc:	8d 42 6c             	lea    0x6c(%edx),%eax
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpunum(), tf->eip, rcr2());
      panic("trap");
    }
...
801057c0:	ff 72 10             	pushl  0x10(%edx)
801057c3:	68 c4 77 10 80       	push   $0x801077c4
801057c8:	e8 73 ae ff ff       	call   80100640 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpunum(), tf->eip,
            rcr2());
    proc->killed = 1;
...
801057d6:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  }
  ...
  // until it gets to the regular system call return.)
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
801057dd:	0f b7 53 3c          	movzwl 0x3c(%ebx),%edx
801057e1:	83 e2 03             	and    $0x3,%edx
801057e4:	66 83 fa 03          	cmp    $0x3,%dx
801057e8:	0f 85 69 ff ff ff    	jne    80105757 <trap+0x57>
    exit();
801057ee:	e8 3d e4 ff ff       	call   80103c30 <exit>
...
801057fb:	0f 85 56 ff ff ff    	jne    80105757 <trap+0x57>
80105801:	e9 73 ff ff ff       	jmp    80105779 <trap+0x79>
...
80105816:	8b 70 24             	mov    0x24(%eax),%esi
80105819:	85 f6                	test   %esi,%esi
8010581b:	0f 85 bf 00 00 00    	jne    801058e0 <trap+0x1e0>
      exit();
    proc->tf = tf;
...
8010582f:	8b 58 24             	mov    0x24(%eax),%ebx
80105832:	85 db                	test   %ebx,%ebx
80105834:	0f 84 3f ff ff ff    	je     80105779 <trap+0x79>
    yield();
...
80105840:	5d                   	pop    %ebp
    ...
    if(proc->killed)
      exit();
80105841:	e9 ea e3 ff ff       	jmp    80103c30 <exit>
...
80105849:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  ...
  // If interrupts were on while locks held, would need to check nlock.
  if(proc && proc->state == RUNNING && tf->trapno == T_IRQ0+IRQ_TIMER)
80105850:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80105854:	0f 85 07 ff ff ff    	jne    80105761 <trap+0x61>
    yield();
8010585a:	e8 21 e5 ff ff       	call   80103d80 <yield>
8010585f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax

  // Check if the process has been killed since we yielded
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
80105865:	85 c0                	test   %eax,%eax
80105867:	0f 85 f4 fe ff ff    	jne    80105761 <trap+0x61>
8010586d:	e9 07 ff ff ff       	jmp    80105779 <trap+0x79>
80105872:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  ...
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80105878:	e8 33 cd ff ff       	call   801025b0 <kbdintr>
    lapiceoi();
8010587d:	e8 ee ce ff ff       	call   80102770 <lapiceoi>
    break;
80105882:	e9 bb fe ff ff       	jmp    80105742 <trap+0x42>
80105887:	89 f6                	mov    %esi,%esi
80105889:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  case T_IRQ0 + IRQ_COM1:
    uartintr();
80105890:	e8 2b 02 00 00       	call   80105ac0 <uartintr>
80105895:	e9 a3 fe ff ff       	jmp    8010573d <trap+0x3d>
...
801058a0:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
801058a4:	8b 7b 38             	mov    0x38(%ebx),%edi
801058a7:	e8 24 ce ff ff       	call   801026d0 <cpunum>
801058ac:	57                   	push   %edi
801058ad:	56                   	push   %esi
801058ae:	50                   	push   %eax
801058af:	68 6c 77 10 80       	push   $0x8010776c
801058b4:	e8 87 ad ff ff       	call   80100640 <cprintf>
            cpunum(), tf->cs, tf->eip);
    lapiceoi();
801058b9:	e8 b2 ce ff ff       	call   80102770 <lapiceoi>
    break;
801058be:	83 c4 10             	add    $0x10,%esp
801058c1:	e9 7c fe ff ff       	jmp    80105742 <trap+0x42>
...
801058c9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
801058d0:	e8 5b c7 ff ff       	call   80102030 <ideintr>
    lapiceoi();
801058d5:	e8 96 ce ff ff       	call   80102770 <lapiceoi>
    break;
801058da:	e9 63 fe ff ff       	jmp    80105742 <trap+0x42>
801058df:	90                   	nop
void
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(proc->killed)
      exit();
801058e0:	e8 4b e3 ff ff       	call   80103c30 <exit>
801058e5:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801058eb:	e9 31 ff ff ff       	jmp    80105821 <trap+0x121>
  }
...
801058f3:	68 a0 38 11 80       	push   $0x801138a0
801058f8:	e8 33 e8 ff ff       	call   80104130 <acquire>
      ticks++;
      wakeup(&ticks);
801058fd:	c7 04 24 e0 40 11 80 	movl   $0x801140e0,(%esp)
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpunum() == 0){
      acquire(&tickslock);
      ticks++;
80105904:	83 05 e0 40 11 80 01 	addl   $0x1,0x801140e0
      wakeup(&ticks);
8010590b:	e8 50 e6 ff ff       	call   80103f60 <wakeup>
      release(&tickslock);
80105910:	c7 04 24 a0 38 11 80 	movl   $0x801138a0,(%esp)
80105917:	e8 f4 e9 ff ff       	call   80104310 <release>
8010591c:	83 c4 10             	add    $0x10,%esp
8010591f:	e9 19 fe ff ff       	jmp    8010573d <trap+0x3d>
80105924:	0f 20 d7             	mov    %cr2,%edi
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      ...
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105927:	8b 73 38             	mov    0x38(%ebx),%esi
8010592a:	e8 a1 cd ff ff       	call   801026d0 <cpunum>
8010592f:	83 ec 0c             	sub    $0xc,%esp
80105932:	57                   	push   %edi
80105933:	56                   	push   %esi
80105934:	50                   	push   %eax
80105935:	ff 73 30             	pushl  0x30(%ebx)
80105938:	68 90 77 10 80       	push   $0x80107790
8010593d:	e8 fe ac ff ff       	call   80100640 <cprintf>
              tf->trapno, cpunum(), tf->eip, rcr2());
      panic("trap");
80105942:	83 c4 14             	add    $0x14,%esp
80105945:	68 66 77 10 80       	push   $0x80107766
8010594a:	e8 01 aa ff ff       	call   80100350 <panic>
8010594f:	90                   	nop
...
80105980 <uartputc.part.0>:
  for(p="xv6 is running for 081530230...\n"; *p; p++)
    uartputc(*p);
}
...
801059a5:	e8 e6 cd ff ff       	call   80102790 <microdelay>
{
  int i;
...
80105a27:	74 5a                	je     80105a83 <uartinit+0xb3>
    return;
  uart = 1;
80105a29:	c7 05 c0 a5 10 80 01 	movl   $0x1,0x8010a5c0
80105a30:	00 00 00 
...
80105a41:	e8 3a d8 ff ff       	call   80103280 <picenable>
  ioapicenable(IRQ_COM1, 0);
80105a46:	59                   	pop    %ecx
80105a47:	5b                   	pop    %ebx
80105a48:	6a 00                	push   $0x0
80105a4a:	6a 04                	push   $0x4
80105a4c:	bb 88 78 10 80       	mov    $0x80107888,%ebx
80105a51:	e8 2a c8 ff ff       	call   80102280 <ioapicenable>
80105a56:	83 c4 10             	add    $0x10,%esp
80105a59:	b8 78 00 00 00       	mov    $0x78,%eax
80105a5e:	eb 0a                	jmp    80105a6a <uartinit+0x9a>
...
uartputc(int c)
{
  ...
  if(!uart)
80105a6a:	8b 15 c0 a5 10 80    	mov    0x8010a5c0,%edx
...
uartputc(int c)
{
  ...
  if(!uart)
80105a90:	8b 15 c0 a5 10 80    	mov    0x8010a5c0,%edx
    uartputc(*p);
}
...
80105acb:	e8 00 ad ff ff       	call   801007d0 <consoleintr>
}
...
80105ad7:	6a 00                	push   $0x0
  jmp alltraps
80105ad9:	e9 20 fb ff ff       	jmp    801055fe <alltraps>
...
80105ae0:	6a 01                	push   $0x1
  jmp alltraps
80105ae2:	e9 17 fb ff ff       	jmp    801055fe <alltraps>
...
80105ae9:	6a 02                	push   $0x2
  jmp alltraps
80105aeb:	e9 0e fb ff ff       	jmp    801055fe <alltraps>
...
80105af2:	6a 03                	push   $0x3
  jmp alltraps
80105af4:	e9 05 fb ff ff       	jmp    801055fe <alltraps>
...
80105afb:	6a 04                	push   $0x4
  jmp alltraps
80105afd:	e9 fc fa ff ff       	jmp    801055fe <alltraps>
...
80105b04:	6a 05                	push   $0x5
  jmp alltraps
80105b06:	e9 f3 fa ff ff       	jmp    801055fe <alltraps>
...
80105b0d:	6a 06                	push   $0x6
  jmp alltraps
80105b0f:	e9 ea fa ff ff       	jmp    801055fe <alltraps>
...
80105b16:	6a 07                	push   $0x7
  jmp alltraps
80105b18:	e9 e1 fa ff ff       	jmp    801055fe <alltraps>
...
80105b1d:	6a 08                	push   $0x8
  jmp alltraps
80105b1f:	e9 da fa ff ff       	jmp    801055fe <alltraps>
...
80105b26:	6a 09                	push   $0x9
  jmp alltraps
80105b28:	e9 d1 fa ff ff       	jmp    801055fe <alltraps>
...
80105b2d:	6a 0a                	push   $0xa
  jmp alltraps
80105b2f:	e9 ca fa ff ff       	jmp    801055fe <alltraps>
...
80105b34:	6a 0b                	push   $0xb
  jmp alltraps
80105b36:	e9 c3 fa ff ff       	jmp    801055fe <alltraps>
...
80105b3b:	6a 0c                	push   $0xc
  jmp alltraps
80105b3d:	e9 bc fa ff ff       	jmp    801055fe <alltraps>
...
80105b42:	6a 0d                	push   $0xd
  jmp alltraps
80105b44:	e9 b5 fa ff ff       	jmp    801055fe <alltraps>
...
80105b49:	6a 0e                	push   $0xe
  jmp alltraps
80105b4b:	e9 ae fa ff ff       	jmp    801055fe <alltraps>
...
80105b52:	6a 0f                	push   $0xf
  jmp alltraps
80105b54:	e9 a5 fa ff ff       	jmp    801055fe <alltraps>
...
80105b5b:	6a 10                	push   $0x10
  jmp alltraps
80105b5d:	e9 9c fa ff ff       	jmp    801055fe <alltraps>
...
80105b62:	6a 11                	push   $0x11
  jmp alltraps
80105b64:	e9 95 fa ff ff       	jmp    801055fe <alltraps>
...
80105b6b:	6a 12                	push   $0x12
  jmp alltraps
80105b6d:	e9 8c fa ff ff       	jmp    801055fe <alltraps>
...
80105b74:	6a 13                	push   $0x13
  jmp alltraps
80105b76:	e9 83 fa ff ff       	jmp    801055fe <alltraps>
...
80105b7d:	6a 14                	push   $0x14
  jmp alltraps
80105b7f:	e9 7a fa ff ff       	jmp    801055fe <alltraps>
...
80105b86:	6a 15                	push   $0x15
  jmp alltraps
80105b88:	e9 71 fa ff ff       	jmp    801055fe <alltraps>
...
80105b8f:	6a 16                	push   $0x16
  jmp alltraps
80105b91:	e9 68 fa ff ff       	jmp    801055fe <alltraps>
...
80105b98:	6a 17                	push   $0x17
  jmp alltraps
80105b9a:	e9 5f fa ff ff       	jmp    801055fe <alltraps>
...
80105ba1:	6a 18                	push   $0x18
  jmp alltraps
80105ba3:	e9 56 fa ff ff       	jmp    801055fe <alltraps>
...
80105baa:	6a 19                	push   $0x19
  jmp alltraps
80105bac:	e9 4d fa ff ff       	jmp    801055fe <alltraps>
...
80105bb3:	6a 1a                	push   $0x1a
  jmp alltraps
80105bb5:	e9 44 fa ff ff       	jmp    801055fe <alltraps>
...
80105bbc:	6a 1b                	push   $0x1b
  jmp alltraps
80105bbe:	e9 3b fa ff ff       	jmp    801055fe <alltraps>
...
80105bc5:	6a 1c                	push   $0x1c
  jmp alltraps
80105bc7:	e9 32 fa ff ff       	jmp    801055fe <alltraps>
...
80105bce:	6a 1d                	push   $0x1d
  jmp alltraps
80105bd0:	e9 29 fa ff ff       	jmp    801055fe <alltraps>
...
80105bd7:	6a 1e                	push   $0x1e
  jmp alltraps
80105bd9:	e9 20 fa ff ff       	jmp    801055fe <alltraps>
...
80105be0:	6a 1f                	push   $0x1f
  jmp alltraps
80105be2:	e9 17 fa ff ff       	jmp    801055fe <alltraps>
...
80105be9:	6a 20                	push   $0x20
  jmp alltraps
80105beb:	e9 0e fa ff ff       	jmp    801055fe <alltraps>
...
80105bf2:	6a 21                	push   $0x21
  jmp alltraps
80105bf4:	e9 05 fa ff ff       	jmp    801055fe <alltraps>
...
80105bfb:	6a 22                	push   $0x22
  jmp alltraps
80105bfd:	e9 fc f9 ff ff       	jmp    801055fe <alltraps>
...
80105c04:	6a 23                	push   $0x23
  jmp alltraps
80105c06:	e9 f3 f9 ff ff       	jmp    801055fe <alltraps>
...
80105c0d:	6a 24                	push   $0x24
  jmp alltraps
80105c0f:	e9 ea f9 ff ff       	jmp    801055fe <alltraps>
...
80105c16:	6a 25                	push   $0x25
  jmp alltraps
80105c18:	e9 e1 f9 ff ff       	jmp    801055fe <alltraps>
...
80105c1f:	6a 26                	push   $0x26
  jmp alltraps
80105c21:	e9 d8 f9 ff ff       	jmp    801055fe <alltraps>
...
80105c28:	6a 27                	push   $0x27
  jmp alltraps
80105c2a:	e9 cf f9 ff ff       	jmp    801055fe <alltraps>
...
80105c31:	6a 28                	push   $0x28
  jmp alltraps
80105c33:	e9 c6 f9 ff ff       	jmp    801055fe <alltraps>
...
80105c3a:	6a 29                	push   $0x29
  jmp alltraps
80105c3c:	e9 bd f9 ff ff       	jmp    801055fe <alltraps>
...
80105c43:	6a 2a                	push   $0x2a
  jmp alltraps
80105c45:	e9 b4 f9 ff ff       	jmp    801055fe <alltraps>
...
80105c4c:	6a 2b                	push   $0x2b
  jmp alltraps
80105c4e:	e9 ab f9 ff ff       	jmp    801055fe <alltraps>
...
80105c55:	6a 2c                	push   $0x2c
  jmp alltraps
80105c57:	e9 a2 f9 ff ff       	jmp    801055fe <alltraps>
...
80105c5e:	6a 2d                	push   $0x2d
  jmp alltraps
80105c60:	e9 99 f9 ff ff       	jmp    801055fe <alltraps>
...
80105c67:	6a 2e                	push   $0x2e
  jmp alltraps
80105c69:	e9 90 f9 ff ff       	jmp    801055fe <alltraps>
...
80105c70:	6a 2f                	push   $0x2f
  jmp alltraps
80105c72:	e9 87 f9 ff ff       	jmp    801055fe <alltraps>
...
80105c79:	6a 30                	push   $0x30
  jmp alltraps
80105c7b:	e9 7e f9 ff ff       	jmp    801055fe <alltraps>
...
80105c82:	6a 31                	push   $0x31
  jmp alltraps
80105c84:	e9 75 f9 ff ff       	jmp    801055fe <alltraps>
...
80105c8b:	6a 32                	push   $0x32
  jmp alltraps
80105c8d:	e9 6c f9 ff ff       	jmp    801055fe <alltraps>
...
80105c94:	6a 33                	push   $0x33
  jmp alltraps
80105c96:	e9 63 f9 ff ff       	jmp    801055fe <alltraps>
...
80105c9d:	6a 34                	push   $0x34
  jmp alltraps
80105c9f:	e9 5a f9 ff ff       	jmp    801055fe <alltraps>
...
80105ca6:	6a 35                	push   $0x35
  jmp alltraps
80105ca8:	e9 51 f9 ff ff       	jmp    801055fe <alltraps>
...
80105caf:	6a 36                	push   $0x36
  jmp alltraps
80105cb1:	e9 48 f9 ff ff       	jmp    801055fe <alltraps>
...
80105cb8:	6a 37                	push   $0x37
  jmp alltraps
80105cba:	e9 3f f9 ff ff       	jmp    801055fe <alltraps>
...
80105cc1:	6a 38                	push   $0x38
  jmp alltraps
80105cc3:	e9 36 f9 ff ff       	jmp    801055fe <alltraps>
...
80105cca:	6a 39                	push   $0x39
  jmp alltraps
80105ccc:	e9 2d f9 ff ff       	jmp    801055fe <alltraps>
...
80105cd3:	6a 3a                	push   $0x3a
  jmp alltraps
80105cd5:	e9 24 f9 ff ff       	jmp    801055fe <alltraps>
...
80105cdc:	6a 3b                	push   $0x3b
  jmp alltraps
80105cde:	e9 1b f9 ff ff       	jmp    801055fe <alltraps>
...
80105ce5:	6a 3c                	push   $0x3c
  jmp alltraps
80105ce7:	e9 12 f9 ff ff       	jmp    801055fe <alltraps>
...
80105cee:	6a 3d                	push   $0x3d
  jmp alltraps
80105cf0:	e9 09 f9 ff ff       	jmp    801055fe <alltraps>
...
80105cf7:	6a 3e                	push   $0x3e
  jmp alltraps
80105cf9:	e9 00 f9 ff ff       	jmp    801055fe <alltraps>
...
80105d00:	6a 3f                	push   $0x3f
  jmp alltraps
80105d02:	e9 f7 f8 ff ff       	jmp    801055fe <alltraps>
...
80105d09:	6a 40                	push   $0x40
  jmp alltraps
80105d0b:	e9 ee f8 ff ff       	jmp    801055fe <alltraps>
...
80105d12:	6a 41                	push   $0x41
  jmp alltraps
80105d14:	e9 e5 f8 ff ff       	jmp    801055fe <alltraps>
...
80105d1b:	6a 42                	push   $0x42
  jmp alltraps
80105d1d:	e9 dc f8 ff ff       	jmp    801055fe <alltraps>
...
80105d24:	6a 43                	push   $0x43
  jmp alltraps
80105d26:	e9 d3 f8 ff ff       	jmp    801055fe <alltraps>
...
80105d2d:	6a 44                	push   $0x44
  jmp alltraps
80105d2f:	e9 ca f8 ff ff       	jmp    801055fe <alltraps>
...
80105d36:	6a 45                	push   $0x45
  jmp alltraps
80105d38:	e9 c1 f8 ff ff       	jmp    801055fe <alltraps>
...
80105d3f:	6a 46                	push   $0x46
  jmp alltraps
80105d41:	e9 b8 f8 ff ff       	jmp    801055fe <alltraps>
...
80105d48:	6a 47                	push   $0x47
  jmp alltraps
80105d4a:	e9 af f8 ff ff       	jmp    801055fe <alltraps>
...
80105d51:	6a 48                	push   $0x48
  jmp alltraps
80105d53:	e9 a6 f8 ff ff       	jmp    801055fe <alltraps>
...
80105d5a:	6a 49                	push   $0x49
  jmp alltraps
80105d5c:	e9 9d f8 ff ff       	jmp    801055fe <alltraps>
...
80105d63:	6a 4a                	push   $0x4a
  jmp alltraps
80105d65:	e9 94 f8 ff ff       	jmp    801055fe <alltraps>
...
80105d6c:	6a 4b                	push   $0x4b
  jmp alltraps
80105d6e:	e9 8b f8 ff ff       	jmp    801055fe <alltraps>
...
80105d75:	6a 4c                	push   $0x4c
  jmp alltraps
80105d77:	e9 82 f8 ff ff       	jmp    801055fe <alltraps>
...
80105d7e:	6a 4d                	push   $0x4d
  jmp alltraps
80105d80:	e9 79 f8 ff ff       	jmp    801055fe <alltraps>
...
80105d87:	6a 4e                	push   $0x4e
  jmp alltraps
80105d89:	e9 70 f8 ff ff       	jmp    801055fe <alltraps>
...
80105d90:	6a 4f                	push   $0x4f
  jmp alltraps
80105d92:	e9 67 f8 ff ff       	jmp    801055fe <alltraps>
...
80105d99:	6a 50                	push   $0x50
  jmp alltraps
80105d9b:	e9 5e f8 ff ff       	jmp    801055fe <alltraps>
...
80105da2:	6a 51                	push   $0x51
  jmp alltraps
80105da4:	e9 55 f8 ff ff       	jmp    801055fe <alltraps>
...
80105dab:	6a 52                	push   $0x52
  jmp alltraps
80105dad:	e9 4c f8 ff ff       	jmp    801055fe <alltraps>
...
80105db4:	6a 53                	push   $0x53
  jmp alltraps
80105db6:	e9 43 f8 ff ff       	jmp    801055fe <alltraps>
...
80105dbd:	6a 54                	push   $0x54
  jmp alltraps
80105dbf:	e9 3a f8 ff ff       	jmp    801055fe <alltraps>
...
80105dc6:	6a 55                	push   $0x55
  jmp alltraps
80105dc8:	e9 31 f8 ff ff       	jmp    801055fe <alltraps>
...
80105dcf:	6a 56                	push   $0x56
  jmp alltraps
80105dd1:	e9 28 f8 ff ff       	jmp    801055fe <alltraps>
...
80105dd8:	6a 57                	push   $0x57
  jmp alltraps
80105dda:	e9 1f f8 ff ff       	jmp    801055fe <alltraps>
...
80105de1:	6a 58                	push   $0x58
  jmp alltraps
80105de3:	e9 16 f8 ff ff       	jmp    801055fe <alltraps>
...
80105dea:	6a 59                	push   $0x59
  jmp alltraps
80105dec:	e9 0d f8 ff ff       	jmp    801055fe <alltraps>
...
80105df3:	6a 5a                	push   $0x5a
  jmp alltraps
80105df5:	e9 04 f8 ff ff       	jmp    801055fe <alltraps>
...
80105dfc:	6a 5b                	push   $0x5b
  jmp alltraps
80105dfe:	e9 fb f7 ff ff       	jmp    801055fe <alltraps>
...
80105e05:	6a 5c                	push   $0x5c
  jmp alltraps
80105e07:	e9 f2 f7 ff ff       	jmp    801055fe <alltraps>
...
80105e0e:	6a 5d                	push   $0x5d
  jmp alltraps
80105e10:	e9 e9 f7 ff ff       	jmp    801055fe <alltraps>
...
80105e17:	6a 5e                	push   $0x5e
  jmp alltraps
80105e19:	e9 e0 f7 ff ff       	jmp    801055fe <alltraps>
...
80105e20:	6a 5f                	push   $0x5f
  jmp alltraps
80105e22:	e9 d7 f7 ff ff       	jmp    801055fe <alltraps>
...
80105e29:	6a 60                	push   $0x60
  jmp alltraps
80105e2b:	e9 ce f7 ff ff       	jmp    801055fe <alltraps>
...
80105e32:	6a 61                	push   $0x61
  jmp alltraps
80105e34:	e9 c5 f7 ff ff       	jmp    801055fe <alltraps>
...
80105e3b:	6a 62                	push   $0x62
  jmp alltraps
80105e3d:	e9 bc f7 ff ff       	jmp    801055fe <alltraps>
...
80105e44:	6a 63                	push   $0x63
  jmp alltraps
80105e46:	e9 b3 f7 ff ff       	jmp    801055fe <alltraps>
...
80105e4d:	6a 64                	push   $0x64
  jmp alltraps
80105e4f:	e9 aa f7 ff ff       	jmp    801055fe <alltraps>
...
80105e56:	6a 65                	push   $0x65
  jmp alltraps
80105e58:	e9 a1 f7 ff ff       	jmp    801055fe <alltraps>
...
80105e5f:	6a 66                	push   $0x66
  jmp alltraps
80105e61:	e9 98 f7 ff ff       	jmp    801055fe <alltraps>
...
80105e68:	6a 67                	push   $0x67
  jmp alltraps
80105e6a:	e9 8f f7 ff ff       	jmp    801055fe <alltraps>
...
80105e71:	6a 68                	push   $0x68
  jmp alltraps
80105e73:	e9 86 f7 ff ff       	jmp    801055fe <alltraps>
...
80105e7a:	6a 69                	push   $0x69
  jmp alltraps
80105e7c:	e9 7d f7 ff ff       	jmp    801055fe <alltraps>
...
80105e83:	6a 6a                	push   $0x6a
  jmp alltraps
80105e85:	e9 74 f7 ff ff       	jmp    801055fe <alltraps>
...
80105e8c:	6a 6b                	push   $0x6b
  jmp alltraps
80105e8e:	e9 6b f7 ff ff       	jmp    801055fe <alltraps>
...
80105e95:	6a 6c                	push   $0x6c
  jmp alltraps
80105e97:	e9 62 f7 ff ff       	jmp    801055fe <alltraps>
...
80105e9e:	6a 6d                	push   $0x6d
  jmp alltraps
80105ea0:	e9 59 f7 ff ff       	jmp    801055fe <alltraps>
...
80105ea7:	6a 6e                	push   $0x6e
  jmp alltraps
80105ea9:	e9 50 f7 ff ff       	jmp    801055fe <alltraps>
...
80105eb0:	6a 6f                	push   $0x6f
  jmp alltraps
80105eb2:	e9 47 f7 ff ff       	jmp    801055fe <alltraps>
...
80105eb9:	6a 70                	push   $0x70
  jmp alltraps
80105ebb:	e9 3e f7 ff ff       	jmp    801055fe <alltraps>
...
80105ec2:	6a 71                	push   $0x71
  jmp alltraps
80105ec4:	e9 35 f7 ff ff       	jmp    801055fe <alltraps>
...
80105ecb:	6a 72                	push   $0x72
  jmp alltraps
80105ecd:	e9 2c f7 ff ff       	jmp    801055fe <alltraps>
...
80105ed4:	6a 73                	push   $0x73
  jmp alltraps
80105ed6:	e9 23 f7 ff ff       	jmp    801055fe <alltraps>
...
80105edd:	6a 74                	push   $0x74
  jmp alltraps
80105edf:	e9 1a f7 ff ff       	jmp    801055fe <alltraps>
...
80105ee6:	6a 75                	push   $0x75
  jmp alltraps
80105ee8:	e9 11 f7 ff ff       	jmp    801055fe <alltraps>
...
80105eef:	6a 76                	push   $0x76
  jmp alltraps
80105ef1:	e9 08 f7 ff ff       	jmp    801055fe <alltraps>
...
80105ef8:	6a 77                	push   $0x77
  jmp alltraps
80105efa:	e9 ff f6 ff ff       	jmp    801055fe <alltraps>
...
80105f01:	6a 78                	push   $0x78
  jmp alltraps
80105f03:	e9 f6 f6 ff ff       	jmp    801055fe <alltraps>
...
80105f0a:	6a 79                	push   $0x79
  jmp alltraps
80105f0c:	e9 ed f6 ff ff       	jmp    801055fe <alltraps>
...
80105f13:	6a 7a                	push   $0x7a
  jmp alltraps
80105f15:	e9 e4 f6 ff ff       	jmp    801055fe <alltraps>
...
80105f1c:	6a 7b                	push   $0x7b
  jmp alltraps
80105f1e:	e9 db f6 ff ff       	jmp    801055fe <alltraps>
...
80105f25:	6a 7c                	push   $0x7c
  jmp alltraps
80105f27:	e9 d2 f6 ff ff       	jmp    801055fe <alltraps>
...
80105f2e:	6a 7d                	push   $0x7d
  jmp alltraps
80105f30:	e9 c9 f6 ff ff       	jmp    801055fe <alltraps>
...
80105f37:	6a 7e                	push   $0x7e
  jmp alltraps
80105f39:	e9 c0 f6 ff ff       	jmp    801055fe <alltraps>
...
80105f40:	6a 7f                	push   $0x7f
  jmp alltraps
80105f42:	e9 b7 f6 ff ff       	jmp    801055fe <alltraps>
...
80105f49:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105f4e:	e9 ab f6 ff ff       	jmp    801055fe <alltraps>
...
80105f55:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80105f5a:	e9 9f f6 ff ff       	jmp    801055fe <alltraps>
...
80105f61:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80105f66:	e9 93 f6 ff ff       	jmp    801055fe <alltraps>
...
80105f6d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80105f72:	e9 87 f6 ff ff       	jmp    801055fe <alltraps>
...
80105f79:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80105f7e:	e9 7b f6 ff ff       	jmp    801055fe <alltraps>
...
80105f85:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80105f8a:	e9 6f f6 ff ff       	jmp    801055fe <alltraps>
...
80105f91:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80105f96:	e9 63 f6 ff ff       	jmp    801055fe <alltraps>
...
80105f9d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80105fa2:	e9 57 f6 ff ff       	jmp    801055fe <alltraps>
...
80105fa9:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80105fae:	e9 4b f6 ff ff       	jmp    801055fe <alltraps>
...
80105fb5:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80105fba:	e9 3f f6 ff ff       	jmp    801055fe <alltraps>
...
80105fc1:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80105fc6:	e9 33 f6 ff ff       	jmp    801055fe <alltraps>
...
80105fcd:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80105fd2:	e9 27 f6 ff ff       	jmp    801055fe <alltraps>
...
80105fd9:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80105fde:	e9 1b f6 ff ff       	jmp    801055fe <alltraps>
...
80105fe5:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80105fea:	e9 0f f6 ff ff       	jmp    801055fe <alltraps>
...
80105ff1:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80105ff6:	e9 03 f6 ff ff       	jmp    801055fe <alltraps>
...
80105ffd:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106002:	e9 f7 f5 ff ff       	jmp    801055fe <alltraps>
...
80106009:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010600e:	e9 eb f5 ff ff       	jmp    801055fe <alltraps>
...
80106015:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010601a:	e9 df f5 ff ff       	jmp    801055fe <alltraps>
...
80106021:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106026:	e9 d3 f5 ff ff       	jmp    801055fe <alltraps>
...
8010602d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106032:	e9 c7 f5 ff ff       	jmp    801055fe <alltraps>
...
80106039:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010603e:	e9 bb f5 ff ff       	jmp    801055fe <alltraps>
...
80106045:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010604a:	e9 af f5 ff ff       	jmp    801055fe <alltraps>
...
80106051:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106056:	e9 a3 f5 ff ff       	jmp    801055fe <alltraps>
...
8010605d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106062:	e9 97 f5 ff ff       	jmp    801055fe <alltraps>
...
80106069:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010606e:	e9 8b f5 ff ff       	jmp    801055fe <alltraps>
...
80106075:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010607a:	e9 7f f5 ff ff       	jmp    801055fe <alltraps>
...
80106081:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106086:	e9 73 f5 ff ff       	jmp    801055fe <alltraps>
...
8010608d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106092:	e9 67 f5 ff ff       	jmp    801055fe <alltraps>
...
80106099:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010609e:	e9 5b f5 ff ff       	jmp    801055fe <alltraps>
...
801060a5:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801060aa:	e9 4f f5 ff ff       	jmp    801055fe <alltraps>
...
801060b1:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801060b6:	e9 43 f5 ff ff       	jmp    801055fe <alltraps>
...
801060bd:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801060c2:	e9 37 f5 ff ff       	jmp    801055fe <alltraps>
...
801060c9:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801060ce:	e9 2b f5 ff ff       	jmp    801055fe <alltraps>
...
801060d5:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801060da:	e9 1f f5 ff ff       	jmp    801055fe <alltraps>
...
801060e1:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801060e6:	e9 13 f5 ff ff       	jmp    801055fe <alltraps>
...
801060ed:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801060f2:	e9 07 f5 ff ff       	jmp    801055fe <alltraps>
...
801060f9:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801060fe:	e9 fb f4 ff ff       	jmp    801055fe <alltraps>
...
80106105:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010610a:	e9 ef f4 ff ff       	jmp    801055fe <alltraps>
...
80106111:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106116:	e9 e3 f4 ff ff       	jmp    801055fe <alltraps>
...
8010611d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106122:	e9 d7 f4 ff ff       	jmp    801055fe <alltraps>
...
80106129:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010612e:	e9 cb f4 ff ff       	jmp    801055fe <alltraps>
...
80106135:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010613a:	e9 bf f4 ff ff       	jmp    801055fe <alltraps>
...
80106141:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106146:	e9 b3 f4 ff ff       	jmp    801055fe <alltraps>
...
8010614d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106152:	e9 a7 f4 ff ff       	jmp    801055fe <alltraps>
...
80106159:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010615e:	e9 9b f4 ff ff       	jmp    801055fe <alltraps>
...
80106165:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010616a:	e9 8f f4 ff ff       	jmp    801055fe <alltraps>
...
80106171:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106176:	e9 83 f4 ff ff       	jmp    801055fe <alltraps>
...
8010617d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106182:	e9 77 f4 ff ff       	jmp    801055fe <alltraps>
...
80106189:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010618e:	e9 6b f4 ff ff       	jmp    801055fe <alltraps>
...
80106195:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010619a:	e9 5f f4 ff ff       	jmp    801055fe <alltraps>
...
801061a1:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801061a6:	e9 53 f4 ff ff       	jmp    801055fe <alltraps>
...
801061ad:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801061b2:	e9 47 f4 ff ff       	jmp    801055fe <alltraps>
...
801061b9:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801061be:	e9 3b f4 ff ff       	jmp    801055fe <alltraps>
...
801061c5:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801061ca:	e9 2f f4 ff ff       	jmp    801055fe <alltraps>
...
801061d1:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801061d6:	e9 23 f4 ff ff       	jmp    801055fe <alltraps>
...
801061dd:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801061e2:	e9 17 f4 ff ff       	jmp    801055fe <alltraps>
...
801061e9:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801061ee:	e9 0b f4 ff ff       	jmp    801055fe <alltraps>
...
801061f5:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801061fa:	e9 ff f3 ff ff       	jmp    801055fe <alltraps>
...
80106201:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106206:	e9 f3 f3 ff ff       	jmp    801055fe <alltraps>
...
8010620d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106212:	e9 e7 f3 ff ff       	jmp    801055fe <alltraps>
...
80106219:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010621e:	e9 db f3 ff ff       	jmp    801055fe <alltraps>
...
80106225:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010622a:	e9 cf f3 ff ff       	jmp    801055fe <alltraps>
...
80106231:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106236:	e9 c3 f3 ff ff       	jmp    801055fe <alltraps>
...
8010623d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106242:	e9 b7 f3 ff ff       	jmp    801055fe <alltraps>
...
80106249:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010624e:	e9 ab f3 ff ff       	jmp    801055fe <alltraps>
...
80106255:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010625a:	e9 9f f3 ff ff       	jmp    801055fe <alltraps>
...
80106261:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106266:	e9 93 f3 ff ff       	jmp    801055fe <alltraps>
...
8010626d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106272:	e9 87 f3 ff ff       	jmp    801055fe <alltraps>
...
80106279:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010627e:	e9 7b f3 ff ff       	jmp    801055fe <alltraps>
...
80106285:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010628a:	e9 6f f3 ff ff       	jmp    801055fe <alltraps>
...
80106291:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106296:	e9 63 f3 ff ff       	jmp    801055fe <alltraps>
...
8010629d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801062a2:	e9 57 f3 ff ff       	jmp    801055fe <alltraps>
...
801062a9:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801062ae:	e9 4b f3 ff ff       	jmp    801055fe <alltraps>
...
801062b5:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801062ba:	e9 3f f3 ff ff       	jmp    801055fe <alltraps>
...
801062c1:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801062c6:	e9 33 f3 ff ff       	jmp    801055fe <alltraps>
...
801062cd:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801062d2:	e9 27 f3 ff ff       	jmp    801055fe <alltraps>
...
801062d9:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801062de:	e9 1b f3 ff ff       	jmp    801055fe <alltraps>
...
801062e5:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801062ea:	e9 0f f3 ff ff       	jmp    801055fe <alltraps>
...
801062f1:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801062f6:	e9 03 f3 ff ff       	jmp    801055fe <alltraps>
...
801062fd:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106302:	e9 f7 f2 ff ff       	jmp    801055fe <alltraps>
...
80106309:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010630e:	e9 eb f2 ff ff       	jmp    801055fe <alltraps>
...
80106315:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010631a:	e9 df f2 ff ff       	jmp    801055fe <alltraps>
...
80106321:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106326:	e9 d3 f2 ff ff       	jmp    801055fe <alltraps>
...
8010632d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106332:	e9 c7 f2 ff ff       	jmp    801055fe <alltraps>
...
80106339:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010633e:	e9 bb f2 ff ff       	jmp    801055fe <alltraps>
...
80106345:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010634a:	e9 af f2 ff ff       	jmp    801055fe <alltraps>
...
80106351:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106356:	e9 a3 f2 ff ff       	jmp    801055fe <alltraps>
...
8010635d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106362:	e9 97 f2 ff ff       	jmp    801055fe <alltraps>
...
80106369:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010636e:	e9 8b f2 ff ff       	jmp    801055fe <alltraps>
...
80106375:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010637a:	e9 7f f2 ff ff       	jmp    801055fe <alltraps>
...
80106381:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106386:	e9 73 f2 ff ff       	jmp    801055fe <alltraps>
...
8010638d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106392:	e9 67 f2 ff ff       	jmp    801055fe <alltraps>
...
80106399:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010639e:	e9 5b f2 ff ff       	jmp    801055fe <alltraps>
...
801063a5:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801063aa:	e9 4f f2 ff ff       	jmp    801055fe <alltraps>
...
801063b1:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801063b6:	e9 43 f2 ff ff       	jmp    801055fe <alltraps>
...
801063bd:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801063c2:	e9 37 f2 ff ff       	jmp    801055fe <alltraps>
...
801063c9:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801063ce:	e9 2b f2 ff ff       	jmp    801055fe <alltraps>
...
801063d5:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801063da:	e9 1f f2 ff ff       	jmp    801055fe <alltraps>
...
801063e1:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801063e6:	e9 13 f2 ff ff       	jmp    801055fe <alltraps>
...
801063ed:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801063f2:	e9 07 f2 ff ff       	jmp    801055fe <alltraps>
...
801063f9:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801063fe:	e9 fb f1 ff ff       	jmp    801055fe <alltraps>
...
80106405:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010640a:	e9 ef f1 ff ff       	jmp    801055fe <alltraps>
...
80106411:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106416:	e9 e3 f1 ff ff       	jmp    801055fe <alltraps>
...
8010641d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106422:	e9 d7 f1 ff ff       	jmp    801055fe <alltraps>
...
80106429:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010642e:	e9 cb f1 ff ff       	jmp    801055fe <alltraps>
...
80106435:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010643a:	e9 bf f1 ff ff       	jmp    801055fe <alltraps>
...
80106441:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106446:	e9 b3 f1 ff ff       	jmp    801055fe <alltraps>
...
8010644d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106452:	e9 a7 f1 ff ff       	jmp    801055fe <alltraps>
...
80106459:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010645e:	e9 9b f1 ff ff       	jmp    801055fe <alltraps>
...
80106465:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010646a:	e9 8f f1 ff ff       	jmp    801055fe <alltraps>
...
80106471:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106476:	e9 83 f1 ff ff       	jmp    801055fe <alltraps>
...
8010647d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106482:	e9 77 f1 ff ff       	jmp    801055fe <alltraps>
...
80106489:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010648e:	e9 6b f1 ff ff       	jmp    801055fe <alltraps>
...
80106495:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010649a:	e9 5f f1 ff ff       	jmp    801055fe <alltraps>
...
801064a1:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801064a6:	e9 53 f1 ff ff       	jmp    801055fe <alltraps>
...
801064ad:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801064b2:	e9 47 f1 ff ff       	jmp    801055fe <alltraps>
...
801064b9:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801064be:	e9 3b f1 ff ff       	jmp    801055fe <alltraps>
...
801064c5:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801064ca:	e9 2f f1 ff ff       	jmp    801055fe <alltraps>
...
801064d1:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801064d6:	e9 23 f1 ff ff       	jmp    801055fe <alltraps>
...
801064dd:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801064e2:	e9 17 f1 ff ff       	jmp    801055fe <alltraps>
...
801064e9:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801064ee:	e9 0b f1 ff ff       	jmp    801055fe <alltraps>
...
801064f5:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801064fa:	e9 ff f0 ff ff       	jmp    801055fe <alltraps>
...
80106501:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106506:	e9 f3 f0 ff ff       	jmp    801055fe <alltraps>
...
8010650d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106512:	e9 e7 f0 ff ff       	jmp    801055fe <alltraps>
...
80106519:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010651e:	e9 db f0 ff ff       	jmp    801055fe <alltraps>
...
80106525:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010652a:	e9 cf f0 ff ff       	jmp    801055fe <alltraps>
...
80106531:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106536:	e9 c3 f0 ff ff       	jmp    801055fe <alltraps>
...
8010653d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106542:	e9 b7 f0 ff ff       	jmp    801055fe <alltraps>
...
801065aa:	e8 b1 dd ff ff       	call   80104360 <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
8010664d:	68 a9 78 10 80       	push   $0x801078a9
80106652:	e8 f9 9c ff ff       	call   80100350 <panic>
...
8010667c:	73 60                	jae    801066de <deallocuvm.part.0+0x7e>
...
80106695:	74 52                	je     801066e9 <deallocuvm.part.0+0x89>
        panic("kfree");
      char *v = P2V(pa);
      kfree(v);
...
801066a4:	e8 17 bc ff ff       	call   801022c0 <kfree>
      *pte = 0;
...
801066bd:	73 1f                	jae    801066de <deallocuvm.part.0+0x7e>
    pte = walkpgdir(pgdir, (char*)a, 0);
...
801066cc:	75 ba                	jne    80106688 <deallocuvm.part.0+0x28>
      a += (NPTENTRIES - 1) * PGSIZE;
801066ce:	81 c3 00 f0 3f 00    	add    $0x3ff000,%ebx
  ...
  a = PGROUNDUP(newsz);
  for(; a  < oldsz; a += PGSIZE){
801066d4:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801066da:	39 f3                	cmp    %esi,%ebx
801066dc:	72 e1                	jb     801066bf <deallocuvm.part.0+0x5f>
      kfree(v);
      *pte = 0;
    }
  }
...
801066de:	8b 45 e0             	mov    -0x20(%ebp),%eax
...
801066ec:	68 3a 72 10 80       	push   $0x8010723a
801066f1:	e8 5a 9c ff ff       	call   80100350 <panic>
...
seginit(void)
{
80106706:	83 ec 14             	sub    $0x14,%esp
  ...
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpunum()];
80106709:	e8 c2 bf ff ff       	call   801026d0 <cpunum>
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
8010670e:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
80106714:	b9 ff ff ff ff       	mov    $0xffffffff,%ecx
80106719:	8d 90 60 13 11 80    	lea    -0x7feeeca0(%eax),%edx
8010671f:	c6 80 dd 13 11 80 9a 	movb   $0x9a,-0x7feeec23(%eax)
80106726:	c6 80 de 13 11 80 cf 	movb   $0xcf,-0x7feeec22(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
8010672d:	c6 80 e5 13 11 80 92 	movb   $0x92,-0x7feeec1b(%eax)
80106734:	c6 80 e6 13 11 80 cf 	movb   $0xcf,-0x7feeec1a(%eax)
  // Map "logical" addresses to virtual addresses using identity map.
  // Cannot share a CODE descriptor for both kernel and user
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpunum()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
8010673b:	66 89 4a 78          	mov    %cx,0x78(%edx)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
8010673f:	b9 ff ff ff ff       	mov    $0xffffffff,%ecx
  // Map "logical" addresses to virtual addresses using identity map.
  // Cannot share a CODE descriptor for both kernel and user
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpunum()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80106744:	66 89 5a 7a          	mov    %bx,0x7a(%edx)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106748:	66 89 8a 80 00 00 00 	mov    %cx,0x80(%edx)
8010674f:	31 db                	xor    %ebx,%ebx
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106751:	b9 ff ff ff ff       	mov    $0xffffffff,%ecx
  // Cannot share a CODE descriptor for both kernel and user
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpunum()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106756:	66 89 9a 82 00 00 00 	mov    %bx,0x82(%edx)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
8010675d:	66 89 8a 90 00 00 00 	mov    %cx,0x90(%edx)
80106764:	31 db                	xor    %ebx,%ebx
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106766:	b9 ff ff ff ff       	mov    $0xffffffff,%ecx
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpunum()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
8010676b:	66 89 9a 92 00 00 00 	mov    %bx,0x92(%edx)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106772:	31 db                	xor    %ebx,%ebx
80106774:	66 89 8a 98 00 00 00 	mov    %cx,0x98(%edx)

  // Map cpu and proc -- these are private per cpu.
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
8010677b:	8d 88 14 14 11 80    	lea    -0x7feeebec(%eax),%ecx
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpunum()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106781:	66 89 9a 9a 00 00 00 	mov    %bx,0x9a(%edx)

  // Map cpu and proc -- these are private per cpu.
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
80106788:	31 db                	xor    %ebx,%ebx
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpunum()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
8010678a:	c6 80 f5 13 11 80 fa 	movb   $0xfa,-0x7feeec0b(%eax)
80106791:	c6 80 f6 13 11 80 cf 	movb   $0xcf,-0x7feeec0a(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);

  // Map cpu and proc -- these are private per cpu.
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
80106798:	66 89 9a 88 00 00 00 	mov    %bx,0x88(%edx)
8010679f:	66 89 8a 8a 00 00 00 	mov    %cx,0x8a(%edx)
801067a6:	89 cb                	mov    %ecx,%ebx
801067a8:	c1 e9 18             	shr    $0x18,%ecx
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpunum()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801067ab:	c6 80 fd 13 11 80 f2 	movb   $0xf2,-0x7feeec03(%eax)
801067b2:	c6 80 fe 13 11 80 cf 	movb   $0xcf,-0x7feeec02(%eax)

  // Map cpu and proc -- these are private per cpu.
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
801067b9:	88 8a 8f 00 00 00    	mov    %cl,0x8f(%edx)
801067bf:	c6 80 ed 13 11 80 92 	movb   $0x92,-0x7feeec13(%eax)
static inline void
lgdt(struct segdesc *p, int size)
{
  ...
  pd[0] = size-1;
801067c6:	b9 37 00 00 00       	mov    $0x37,%ecx
801067cb:	c6 80 ee 13 11 80 c0 	movb   $0xc0,-0x7feeec12(%eax)

  lgdt(c->gdt, sizeof(c->gdt));
801067d2:	05 d0 13 11 80       	add    $0x801113d0,%eax
801067d7:	66 89 4d f2          	mov    %cx,-0xe(%ebp)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
  ...
  // Map cpu and proc -- these are private per cpu.
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
801067db:	c1 eb 10             	shr    $0x10,%ebx
  pd[1] = (uint)p;
801067de:	66 89 45 f4          	mov    %ax,-0xc(%ebp)
  pd[2] = (uint)p >> 16;
801067e2:	c1 e8 10             	shr    $0x10,%eax
  ...
  c = &cpus[cpunum()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801067e5:	c6 42 7c 00          	movb   $0x0,0x7c(%edx)
801067e9:	c6 42 7f 00          	movb   $0x0,0x7f(%edx)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801067ed:	c6 82 84 00 00 00 00 	movb   $0x0,0x84(%edx)
801067f4:	c6 82 87 00 00 00 00 	movb   $0x0,0x87(%edx)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801067fb:	c6 82 94 00 00 00 00 	movb   $0x0,0x94(%edx)
80106802:	c6 82 97 00 00 00 00 	movb   $0x0,0x97(%edx)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106809:	c6 82 9c 00 00 00 00 	movb   $0x0,0x9c(%edx)
80106810:	c6 82 9f 00 00 00 00 	movb   $0x0,0x9f(%edx)

  // Map cpu and proc -- these are private per cpu.
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
80106817:	88 9a 8c 00 00 00    	mov    %bl,0x8c(%edx)
8010681d:	66 89 45 f6          	mov    %ax,-0xa(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
80106821:	8d 45 f2             	lea    -0xe(%ebp),%eax
80106824:	0f 01 10             	lgdtl  (%eax)
}
...
80106827:	b8 18 00 00 00       	mov    $0x18,%eax
8010682c:	8e e8                	mov    %eax,%gs
  lgdt(c->gdt, sizeof(c->gdt));
  loadgs(SEG_KCPU << 3);
  ...
  cpu = c;
  proc = 0;
8010682e:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
80106835:	00 00 00 00 
  ...
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpunum()];
80106839:	65 89 15 00 00 00 00 	mov    %edx,%gs:0x0
  loadgs(SEG_KCPU << 3);
...
80106840:	83 c4 14             	add    $0x14,%esp
80106843:	5b                   	pop    %ebx
80106844:	5d                   	pop    %ebp
80106845:	c3                   	ret    
...
80106855:	e8 16 bc ff ff       	call   80102470 <kalloc>
8010685a:	85 c0                	test   %eax,%eax
8010685c:	74 52                	je     801068b0 <setupkvm+0x60>
    return 0;
...
80106863:	bb 20 a4 10 80       	mov    $0x8010a420,%ebx
  pde_t *pgdir;
  struct kmap *k;
  ...
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
80106868:	68 00 10 00 00       	push   $0x1000
8010686d:	6a 00                	push   $0x0
8010686f:	50                   	push   %eax
80106870:	e8 eb da ff ff       	call   80104360 <memset>
80106875:	83 c4 10             	add    $0x10,%esp
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
80106878:	8b 43 04             	mov    0x4(%ebx),%eax
8010687b:	8b 4b 08             	mov    0x8(%ebx),%ecx
8010687e:	83 ec 08             	sub    $0x8,%esp
80106881:	8b 13                	mov    (%ebx),%edx
80106883:	ff 73 0c             	pushl  0xc(%ebx)
80106886:	50                   	push   %eax
80106887:	29 c1                	sub    %eax,%ecx
80106889:	89 f0                	mov    %esi,%eax
8010688b:	e8 40 fd ff ff       	call   801065d0 <mappages>
80106890:	83 c4 10             	add    $0x10,%esp
80106893:	85 c0                	test   %eax,%eax
80106895:	78 19                	js     801068b0 <setupkvm+0x60>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80106897:	83 c3 10             	add    $0x10,%ebx
8010689a:	81 fb 60 a4 10 80    	cmp    $0x8010a460,%ebx
801068a0:	75 d6                	jne    80106878 <setupkvm+0x28>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
...
801068c3:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
801068c6:	e8 85 ff ff ff       	call   80106850 <setupkvm>
801068cb:	a3 e4 40 11 80       	mov    %eax,0x801140e4
}
...
801068d0:	05 00 00 00 80       	add    $0x80000000,%eax
801068d5:	0f 22 d8             	mov    %eax,%cr3
  switchkvm();
}
801068d8:	c9                   	leave  
801068d9:	c3                   	ret    
...
801068e0 <switchkvm>:
801068e0:	a1 e4 40 11 80       	mov    0x801140e4,%eax
...
80106907:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
8010690a:	e8 81 d9 ff ff       	call   80104290 <pushcli>
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
8010690f:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106915:	b9 67 00 00 00       	mov    $0x67,%ecx
8010691a:	8d 50 08             	lea    0x8(%eax),%edx
8010691d:	66 89 88 a0 00 00 00 	mov    %cx,0xa0(%eax)
80106924:	c6 80 a6 00 00 00 40 	movb   $0x40,0xa6(%eax)
  cpu->gdt[SEG_TSS].s = 0;
8010692b:	c6 80 a5 00 00 00 89 	movb   $0x89,0xa5(%eax)
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
  pushcli();
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
80106932:	66 89 90 a2 00 00 00 	mov    %dx,0xa2(%eax)
80106939:	89 d1                	mov    %edx,%ecx
8010693b:	c1 ea 18             	shr    $0x18,%edx
8010693e:	88 90 a7 00 00 00    	mov    %dl,0xa7(%eax)
  cpu->gdt[SEG_TSS].s = 0;
  cpu->ts.ss0 = SEG_KDATA << 3;
80106944:	ba 10 00 00 00       	mov    $0x10,%edx
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
  pushcli();
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
80106949:	c1 e9 10             	shr    $0x10,%ecx
  cpu->gdt[SEG_TSS].s = 0;
  cpu->ts.ss0 = SEG_KDATA << 3;
8010694c:	66 89 50 10          	mov    %dx,0x10(%eax)
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
80106950:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
  pushcli();
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
80106957:	88 88 a4 00 00 00    	mov    %cl,0xa4(%eax)
  cpu->gdt[SEG_TSS].s = 0;
  cpu->ts.ss0 = SEG_KDATA << 3;
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
...
8010695d:	b9 ff ff ff ff       	mov    $0xffffffff,%ecx
{
  pushcli();
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
  cpu->gdt[SEG_TSS].s = 0;
  cpu->ts.ss0 = SEG_KDATA << 3;
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
80106962:	8b 52 08             	mov    0x8(%edx),%edx
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  cpu->ts.iomb = (ushort) 0xFFFF;
80106965:	66 89 48 6e          	mov    %cx,0x6e(%eax)
{
  pushcli();
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
  cpu->gdt[SEG_TSS].s = 0;
  cpu->ts.ss0 = SEG_KDATA << 3;
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
80106969:	81 c2 00 10 00 00    	add    $0x1000,%edx
8010696f:	89 50 0c             	mov    %edx,0xc(%eax)
}
...
80106972:	b8 30 00 00 00       	mov    $0x30,%eax
80106977:	0f 00 d8             	ltr    %ax
  ...
  ltr(SEG_TSS << 3);
  if(p->pgdir == 0)
8010697a:	8b 43 04             	mov    0x4(%ebx),%eax
8010697d:	85 c0                	test   %eax,%eax
8010697f:	74 11                	je     80106992 <switchuvm+0x92>
}
...
{
  asm volatile("movl %0,%%cr3" : : "r" (val));
80106981:	05 00 00 00 80       	add    $0x80000000,%eax
80106986:	0f 22 d8             	mov    %eax,%cr3
    panic("switchuvm: no pgdir");
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
}
80106989:	8b 5d fc             	mov    -0x4(%ebp),%ebx
8010698c:	c9                   	leave  
  cpu->ts.iomb = (ushort) 0xFFFF;
  ltr(SEG_TSS << 3);
  if(p->pgdir == 0)
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
8010698d:	e9 2e d9 ff ff       	jmp    801042c0 <popcli>
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  cpu->ts.iomb = (ushort) 0xFFFF;
  ltr(SEG_TSS << 3);
...
80106995:	68 af 78 10 80       	push   $0x801078af
8010699a:	e8 b1 99 ff ff       	call   80100350 <panic>
8010699f:	90                   	nop
...
801069bb:	77 49                	ja     80106a06 <inituvm+0x66>
  ...
  mem = kalloc();
801069bd:	e8 ae ba ff ff       	call   80102470 <kalloc>
  memset(mem, 0, PGSIZE);
...
801069cf:	e8 8c d9 ff ff       	call   80104360 <memset>
...
801069e9:	e8 e2 fb ff ff       	call   801065d0 <mappages>
  memmove(mem, init, sz);
...
80106a00:	5d                   	pop    %ebp
  ...
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
80106a01:	e9 0a da ff ff       	jmp    80104410 <memmove>
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem;
...
80106a09:	68 c3 78 10 80       	push   $0x801078c3
80106a0e:	e8 3d 99 ff ff       	call   80100350 <panic>
...
80106a63:	e8 e8 fa ff ff       	call   80106550 <walkpgdir>
...
80106a91:	e8 8a ae ff ff       	call   80101920 <readi>
...
80106abd:	68 dd 78 10 80       	push   $0x801078dd
80106ac2:	e8 89 98 ff ff       	call   80100350 <panic>
{
  uint i, pa, n;
  pte_t *pte;
...
80106aca:	68 80 79 10 80       	push   $0x80107980
80106acf:	e8 7c 98 ff ff       	call   80100350 <panic>
...
80106b23:	e8 38 d8 ff ff       	call   80104360 <memset>
...
80106b3d:	e8 8e fa ff ff       	call   801065d0 <mappages>
...
80106b51:	76 7d                	jbe    80106bd0 <allocuvm+0xf0>
    mem = kalloc();
80106b53:	e8 18 b9 ff ff       	call   80102470 <kalloc>
    if(mem == 0){
...
80106b61:	68 fb 78 10 80       	push   $0x801078fb
80106b66:	e8 d5 9a ff ff       	call   80100640 <cprintf>
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
{
  pte_t *pte;
  uint a, pa;
...
80106b7b:	e8 e0 fa ff ff       	call   80106660 <deallocuvm.part.0>
  for(; a < newsz; a += PGSIZE){
    mem = kalloc();
    if(mem == 0){
      cprintf("allocuvm out of memory\n");
...
80106b93:	68 13 79 10 80       	push   $0x80107913
80106b98:	e8 a3 9a ff ff       	call   80100640 <cprintf>
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
{
  pte_t *pte;
  uint a, pa;
...
80106bad:	e8 ae fa ff ff       	call   80106660 <deallocuvm.part.0>
    }
    memset(mem, 0, PGSIZE);
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      cprintf("allocuvm out of memory (2)\n");
...
80106bb6:	e8 05 b7 ff ff       	call   801022c0 <kfree>
      return 0;
...
80106bf0:	5d                   	pop    %ebp
80106bf1:	e9 6a fa ff ff       	jmp    80106660 <deallocuvm.part.0>
...
80106c29:	e8 32 fa ff ff       	call   80106660 <deallocuvm.part.0>
...
80106c5e:	e8 5d b6 ff ff       	call   801022c0 <kfree>
...
80106c73:	5d                   	pop    %ebp
  ...
  kfree((char*)pgdir);
80106c74:	e9 47 b6 ff ff       	jmp    801022c0 <kfree>
freevm(pde_t *pgdir)
{
  uint i;
...
80106c7c:	68 2f 79 10 80       	push   $0x8010792f
80106c81:	e8 ca 96 ff ff       	call   80100350 <panic>
...
80106c9e:	e8 ad f8 ff ff       	call   80106550 <walkpgdir>
  if(pte == 0)
...
80106caf:	68 40 79 10 80       	push   $0x80107940
80106cb4:	e8 97 96 ff ff       	call   80100350 <panic>
...
80106cf3:	81 c7 00 00 00 80    	add    $0x80000000,%edi
80106cf9:	68 00 10 00 00       	push   $0x1000
80106cfe:	57                   	push   %edi
80106cff:	50                   	push   %eax
80106d00:	e8 0b d7 ff ff       	call   80104410 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0)
80106d05:	58                   	pop    %eax
80106d06:	5a                   	pop    %edx
80106d07:	8d 93 00 00 00 80    	lea    -0x80000000(%ebx),%edx
80106d0d:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106d10:	ff 75 e4             	pushl  -0x1c(%ebp)
80106d13:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106d18:	52                   	push   %edx
80106d19:	89 f2                	mov    %esi,%edx
80106d1b:	e8 b0 f8 ff ff       	call   801065d0 <mappages>
80106d20:	83 c4 10             	add    $0x10,%esp
80106d23:	85 c0                	test   %eax,%eax
80106d25:	78 3e                	js     80106d65 <copyuvm+0xa5>
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106d27:	81 c6 00 10 00 00    	add    $0x1000,%esi
80106d2d:	39 75 0c             	cmp    %esi,0xc(%ebp)
80106d30:	76 4e                	jbe    80106d80 <copyuvm+0xc0>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106d32:	8b 45 08             	mov    0x8(%ebp),%eax
80106d35:	31 c9                	xor    %ecx,%ecx
80106d37:	89 f2                	mov    %esi,%edx
80106d39:	e8 12 f8 ff ff       	call   80106550 <walkpgdir>
80106d3e:	85 c0                	test   %eax,%eax
80106d40:	74 5a                	je     80106d9c <copyuvm+0xdc>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
80106d42:	8b 18                	mov    (%eax),%ebx
80106d44:	f6 c3 01             	test   $0x1,%bl
80106d47:	74 46                	je     80106d8f <copyuvm+0xcf>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106d49:	89 df                	mov    %ebx,%edi
    flags = PTE_FLAGS(*pte);
80106d4b:	81 e3 ff 0f 00 00    	and    $0xfff,%ebx
80106d51:	89 5d e4             	mov    %ebx,-0x1c(%ebp)
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106d54:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
80106d5a:	e8 11 b7 ff ff       	call   80102470 <kalloc>
80106d5f:	85 c0                	test   %eax,%eax
80106d61:	89 c3                	mov    %eax,%ebx
80106d63:	75 8b                	jne    80106cf0 <copyuvm+0x30>
      goto bad;
  }
  return d;
...
80106d68:	ff 75 e0             	pushl  -0x20(%ebp)
80106d6b:	e8 a0 fe ff ff       	call   80106c10 <freevm>
  return 0;
...
80106d8d:	eb e6                	jmp    80106d75 <copyuvm+0xb5>
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
...
80106d92:	68 64 79 10 80       	push   $0x80107964
80106d97:	e8 b4 95 ff ff       	call   80100350 <panic>
...
80106d9f:	68 4a 79 10 80       	push   $0x8010794a
80106da4:	e8 a7 95 ff ff       	call   80100350 <panic>
...
80106dbe:	e8 8d f7 ff ff       	call   80106550 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
80106e2f:	e8 dc d5 ff ff       	call   80104410 <memmove>
    len -= n;
    buf += n;
...
80106e80:	5d                   	pop    %ebp
80106e81:	c3                   	ret    
80106e82:	66 90                	xchg   %ax,%ax
80106e84:	66 90                	xchg   %ax,%ax
80106e86:	66 90                	xchg   %ax,%ax
80106e88:	66 90                	xchg   %ax,%ax
80106e8a:	66 90                	xchg   %ax,%ax
80106e8c:	66 90                	xchg   %ax,%ax
...
80106e96:	68 85 75 10 80       	push   $0x80107585
80106e9b:	68 e0 a5 10 80       	push   $0x8010a5e0
80106ea0:	e8 6b d2 ff ff       	call   80104110 <initlock>
	acquire(&lock_var);
80106ea5:	c7 04 24 e0 a5 10 80 	movl   $0x8010a5e0,(%esp)
80106eac:	e8 7f d2 ff ff       	call   80104130 <acquire>
80106eb1:	b8 20 a6 10 80       	mov    $0x8010a620,%eax
80106eb6:	83 c4 10             	add    $0x10,%esp
80106eb9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
	for(i = 0; i < NLOCK; i++){
		locks[i] = UNLOCKED;
80106ec0:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
80106ec6:	83 c0 04             	add    $0x4,%eax
lock_init(void)
{
	int i;
	initlock(&lock_var, "lock");
	acquire(&lock_var);
	for(i = 0; i < NLOCK; i++){
80106ec9:	3d 48 a6 10 80       	cmp    $0x8010a648,%eax
80106ece:	75 f0                	jne    80106ec0 <lock_init+0x30>
		locks[i] = UNLOCKED;
	}
	release(&lock_var);	
80106ed0:	83 ec 0c             	sub    $0xc,%esp
80106ed3:	68 e0 a5 10 80       	push   $0x8010a5e0
80106ed8:	e8 33 d4 ff ff       	call   80104310 <release>
}
...
80106ef7:	8b 5d 08             	mov    0x8(%ebp),%ebx
 *  ロック変数の番号の範囲チェック
 */
static int
check_lock(int lkid)
...
80106efa:	83 fb 09             	cmp    $0x9,%ebx
80106efd:	77 5b                	ja     80106f5a <lock+0x6a>
		return -1;
	}
	/*
...
80106f02:	68 e0 a5 10 80       	push   $0x8010a5e0
80106f07:	e8 24 d2 ff ff       	call   80104130 <acquire>
	if (locks[lkid] == LOCKED) {
80106f0c:	83 c4 10             	add    $0x10,%esp
80106f0f:	83 3c 9d 20 a6 10 80 	cmpl   $0x2,-0x7fef59e0(,%ebx,4)
80106f16:	02 
80106f17:	74 27                	je     80106f40 <lock+0x50>
...
80106f19:	83 ec 0c             	sub    $0xc,%esp
	...
	locks[lkid] = LOCKED;
80106f1c:	c7 04 9d 20 a6 10 80 	movl   $0x2,-0x7fef59e0(,%ebx,4)
80106f23:	02 00 00 00 
	release(&lock_var);
80106f27:	68 e0 a5 10 80       	push   $0x8010a5e0
80106f2c:	e8 df d3 ff ff       	call   80104310 <release>
	return 1;
}
80106f31:	b8 01 00 00 00       	mov    $0x1,%eax
80106f36:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80106f39:	c9                   	leave  
80106f3a:	c3                   	ret    
80106f3b:	90                   	nop
80106f3c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
	...
	if (locks[lkid] == LOCKED) {
		sleep(&locks[lkid], &lock_var);
80106f40:	8d 04 9d 20 a6 10 80 	lea    -0x7fef59e0(,%ebx,4),%eax
80106f47:	83 ec 08             	sub    $0x8,%esp
80106f4a:	68 e0 a5 10 80       	push   $0x8010a5e0
80106f4f:	50                   	push   %eax
80106f50:	e8 6b ce ff ff       	call   80103dc0 <sleep>
80106f55:	83 c4 10             	add    $0x10,%esp
80106f58:	eb bf                	jmp    80106f19 <lock+0x29>
 */
static int
check_lock(int lkid)
{
...
80106f5d:	68 a4 79 10 80       	push   $0x801079a4
80106f62:	e8 e9 93 ff ff       	call   80100350 <panic>
...
{
	if (lkid < 0 || lkid >= NLOCK) {
80106f7a:	83 fb 09             	cmp    $0x9,%ebx
80106f7d:	77 3d                	ja     80106fbc <unlock+0x4c>
unlock(int lkid)
{
	if (!check_lock(lkid)) {
		return -1;
...
80106f82:	68 e0 a5 10 80       	push   $0x8010a5e0
80106f87:	e8 a4 d1 ff ff       	call   80104130 <acquire>
	locks[lkid] = UNLOCKED;
	wakeup(&locks[lkid]); /* このロックの解放を待っていたプロセスを起こす */
80106f8c:	8d 04 9d 20 a6 10 80 	lea    -0x7fef59e0(,%ebx,4),%eax
{
	if (!check_lock(lkid)) {
		return -1;
	}
	acquire(&lock_var);
	locks[lkid] = UNLOCKED;
80106f93:	c7 04 9d 20 a6 10 80 	movl   $0x1,-0x7fef59e0(,%ebx,4)
80106f9a:	01 00 00 00 
	wakeup(&locks[lkid]); /* このロックの解放を待っていたプロセスを起こす */
80106f9e:	89 04 24             	mov    %eax,(%esp)
80106fa1:	e8 ba cf ff ff       	call   80103f60 <wakeup>
	release(&lock_var);
80106fa6:	c7 04 24 e0 a5 10 80 	movl   $0x8010a5e0,(%esp)
80106fad:	e8 5e d3 ff ff       	call   80104310 <release>
	return 1;
}
80106fb2:	b8 01 00 00 00       	mov    $0x1,%eax
...
80106fbf:	68 a4 79 10 80       	push   $0x801079a4
80106fc4:	e8 87 93 ff ff       	call   80100350 <panic>
