...
main(int argc, char *argv[])
{
  ...
  1c:	50                   	push   %eax
  1d:	50                   	push   %eax
  1e:	68 20 08 00 00       	push   $0x820
  23:	6a 01                	push   $0x1
  25:	e8 d6 04 00 00       	call   500 <printf>
    exit();
  2a:	e8 73 03 00 00       	call   3a2 <exit>
  }
  ...
  36:	e8 a7 03 00 00       	call   3e2 <open>
  3b:	83 c4 10             	add    $0x10,%esp
  3e:	85 c0                	test   %eax,%eax
  40:	89 c6                	mov    %eax,%esi
  42:	78 3a                	js     7e <main+0x7e>
  ...
  4e:	e8 8f 03 00 00       	call   3e2 <open>
  53:	83 c4 10             	add    $0x10,%esp
  56:	85 c0                	test   %eax,%eax
  58:	89 c7                	mov    %eax,%edi
  5a:	78 37                	js     93 <main+0x93>
      exit();
    }
    cp1(fdread,fdwrite);
    chdir("..");
  ...
  5e:	57                   	push   %edi
  5f:	56                   	push   %esi
  60:	e8 ab 00 00 00       	call   110 <cp1>
  ...
  6b:	56                   	push   %esi
  6c:	e8 59 03 00 00       	call   3ca <close>
  close(fdwrite);  
  71:	89 3c 24             	mov    %edi,(%esp)
  74:	e8 51 03 00 00       	call   3ca <close>
  exit();
  79:	e8 24 03 00 00       	call   3a2 <exit>
    printf(1, "usege: cp [filename] [filename or dir]\n");
    exit();
  }
  ...
  if((fdread = open(argv[1], 0)) < 0){
    printf(1, "cp: cannot open %s\n", argv[1]);
  7e:	50                   	push   %eax
  7f:	ff 73 04             	pushl  0x4(%ebx)
  82:	68 48 08 00 00       	push   $0x848
  87:	6a 01                	push   $0x1
  89:	e8 72 04 00 00       	call   500 <printf>
    exit();
  8e:	e8 0f 03 00 00       	call   3a2 <exit>
  }
  if((fdwrite = open(argv[2], O_CREATE|O_RDWR)) < 0){
    if(chdir(argv[2])<0){
  93:	83 ec 0c             	sub    $0xc,%esp
  96:	ff 73 08             	pushl  0x8(%ebx)
  99:	e8 74 03 00 00       	call   412 <chdir>
  9e:	83 c4 10             	add    $0x10,%esp
  a1:	85 c0                	test   %eax,%eax
  a3:	78 3b                	js     e0 <main+0xe0>
  ...
  a8:	57                   	push   %edi
  a9:	e8 1c 03 00 00       	call   3ca <close>
    if((fdwrite = open(argv[1], O_CREATE|O_RDWR)) < 0){
  ae:	59                   	pop    %ecx
  af:	5f                   	pop    %edi
  b0:	68 02 02 00 00       	push   $0x202
  b5:	ff 73 04             	pushl  0x4(%ebx)
  b8:	e8 25 03 00 00       	call   3e2 <open>
  bd:	83 c4 10             	add    $0x10,%esp
  c0:	85 c0                	test   %eax,%eax
  c2:	89 c7                	mov    %eax,%edi
  c4:	78 2f                	js     f5 <main+0xf5>
  ...
  c8:	50                   	push   %eax
  c9:	56                   	push   %esi
  ca:	e8 41 00 00 00       	call   110 <cp1>
    chdir("..");
  cf:	c7 04 24 85 08 00 00 	movl   $0x885,(%esp)
  d6:	e8 37 03 00 00       	call   412 <chdir>
  db:	83 c4 10             	add    $0x10,%esp
  de:	eb 88                	jmp    68 <main+0x68>
    printf(1, "cp: cannot open %s\n", argv[1]);
    exit();
  }
  if((fdwrite = open(argv[2], O_CREATE|O_RDWR)) < 0){
    if(chdir(argv[2])<0){
      printf(1,"cp: cant find %s\n",argv[2]);
  e0:	50                   	push   %eax
  e1:	ff 73 08             	pushl  0x8(%ebx)
  e4:	68 5c 08 00 00       	push   $0x85c
  e9:	6a 01                	push   $0x1
  eb:	e8 10 04 00 00       	call   500 <printf>
      exit();
  f0:	e8 ad 02 00 00       	call   3a2 <exit>
    }
    close(fdwrite);
    if((fdwrite = open(argv[1], O_CREATE|O_RDWR)) < 0){
      printf(1, "cp: cannot open %s/%s\n", argv[2],argv[1]);
  f5:	ff 73 04             	pushl  0x4(%ebx)
  f8:	ff 73 08             	pushl  0x8(%ebx)
  fb:	68 6e 08 00 00       	push   $0x86e
 100:	6a 01                	push   $0x1
 102:	e8 f9 03 00 00       	call   500 <printf>
      exit();
 107:	e8 96 02 00 00       	call   3a2 <exit>
...
void cp1(int fdread,int fdwrite){
 ...
 11b:	eb 15                	jmp    132 <cp1+0x22>
 11d:	8d 76 00             	lea    0x0(%esi),%esi
    write(fdwrite, buf, n);//文字出力
 120:	83 ec 04             	sub    $0x4,%esp
 123:	50                   	push   %eax
 124:	68 80 0b 00 00       	push   $0xb80
 129:	56                   	push   %esi
 12a:	e8 93 02 00 00       	call   3c2 <write>
...
void cp1(int fdread,int fdwrite){
 ...
 135:	68 00 02 00 00       	push   $0x200
 13a:	68 80 0b 00 00       	push   $0xb80
 13f:	53                   	push   %ebx
 140:	e8 75 02 00 00       	call   3ba <read>
 145:	83 c4 10             	add    $0x10,%esp
 148:	85 c0                	test   %eax,%eax
 14a:	7f d4                	jg     120 <cp1+0x10>
    write(fdwrite, buf, n);//文字出力
  }
}
 14c:	8d 65 f8             	lea    -0x8(%ebp),%esp
 14f:	5b                   	pop    %ebx
 150:	5e                   	pop    %esi
 151:	5d                   	pop    %ebp
 152:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 49f:	f7 f6                	div    %esi
 4a1:	0f b6 92 90 08 00 00 	movzbl 0x890(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 618:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 61b:	b8 88 08 00 00       	mov    $0x888,%eax
